...
import {
    ...
    Activity, Zap, Sparkles, BookOpen, MessageCircle, Menu, ChevronRight,
} from "lucide-react"
...
export function TrainerLayout({ children, brandName, logoUrl, primaryColor }: TrainerLayoutProps) {
    ...
    const mobileNavItems = [
        ...
        { href: "/dashboard/workouts/ai-generate", icon: Sparkles,        label: "IA"      },
    ...
    return (
        <div className="flex h-dvh w-full bg-background overflow-hidden">
            ...
            {/* ── Mobile header ── */}
            {/* Logout REMOVIDO daqui — vai para /dashboard/settings */}
