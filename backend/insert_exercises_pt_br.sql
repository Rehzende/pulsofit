INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'e741250d-cd58-4279-8bf6-9a9e1ef338f8',
    'Abdominal',
    'strength',
    'Sit-Up performed 3/4 of the way up',
    '["Lie down on the floor and secure your feet. Your legs should be bent at the knees.", "Place your hands behind or to the side of your head. You will begin with your back on the ground. This will be your starting position.", "Flex your hips and spine to raise your torso toward your knees.", "At the top of the contraction your torso should be perpendicular to the ground. Reverse the motion, going only  of the way down.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '12cd1f32-adc2-4759-95cc-1b2c1c8c219e',
    'Rosca Inclinado Alternado com Halteres',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '05fa6acd-5f7a-4fef-ad95-1f1af73724fc',
    'Alternado Leg Diagonal Bound',
    'plyometrics',
    NULL,
    '["Assume a comfortable stance with one foot slightly in front of the other.", "Begin by pushing off with the front leg, driving the opposite knee forward and as high as possible before landing. Attempt to cover as much distance to each side with each bound.", "It may help to use a line on the ground to guage distance from side to side.", "Repeat the sequence with the other leg."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'fc633fc3-e3cd-4be0-a95c-418249d353e7',
    'Desenvolvimento de Ombros Alternado na Polia',
    'strength',
    NULL,
    '["Move the cables to the bottom of the tower and select an appropriate weight.", "Grasp the cables and hold them at shoulder height, palms facing forward. This will be your starting position.", "Keeping your head and chest up, extend through the elbow to press one side directly over head.", "After pausing at the top, return to the starting position and repeat on the opposite side."]'::jsonb,
    '["cable"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ac3d9ae7-2b4a-4458-ad67-c44052f8f144',
    'Desenvolvimento Alternado com Kettlebell',
    'strength',
    NULL,
    '["Clean two kettlebells to your shoulders. Clean the kettlebells to your shoulders by extending through the legs and hips as you pull the kettlebells towards your shoulders. Rotate your wrists as you do so.", "Press one directly overhead by extending through the elbow, turning it so the palm faces forward while holding the other kettlebell stationary .", "Lower the pressed kettlebell to the starting position and immediately press with your other arm."]'::jsonb,
    '["kettlebell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '8e67289f-87d7-42b4-8a62-ae804bf70267',
    'Ankle On The Knee',
    'stretching',
    NULL,
    '["From a lying position, bend your knees and keep your feet on the floor.", "Place your ankle of one foot on your opposite knee.", "Grasp the thigh or knee of the bottom leg and pull both of your legs into the chest. Relax your neck and shoulders. Hold for 10-20 seconds and then switch sides."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'a7f8b865-6314-4d99-8df5-0ca86ad8d152',
    'Anterior Tibialis-SMR',
    'stretching',
    NULL,
    '["Begin seated on the ground with your legs bent and your feet on the floor.", "Using a Muscle Roller or a rolling pin, apply pressure to the muscles on the outside of your shins. Work from just below the knee to above the ankle, pausing at points of tension for 10-30 seconds. Repeat on the other leg."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'a727adad-64c7-4eb1-9e0d-3d34066738e0',
    'Around The Worlds',
    'strength',
    NULL,
    '["Lay down on a flat bench holding a dumbbell in each hand with the palms of the hands facing towards the ceiling. Tip: Your arms should be parallel to the floor and next to your thighs. To avoid injury, make sure that you keep your elbows slightly bent. This will be your starting position.", "Now move the dumbbells by creating a semi-circle as you displace them from the initial position to over the head. All of the movement should happen with the arms parallel to the floor at all times. Breathe in as you perform this portion of the movement.", "Reverse the movement to return the weight to the starting position as you exhale."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'CHEST',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'c8b79d8a-2bf7-4923-a16b-6d9d7b47c404',
    'Backward Drag',
    'strongman',
    NULL,
    '["Load a sled with the desired weight, attaching a rope or straps to the sled that you can hold onto.", "Begin the exercise by moving backwards for a given distance. Leaning back, extend through the legs for short steps to move as quickly as possible."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '6d96dcba-9854-4c57-bd7e-4607742220ea',
    'Balance Board',
    'strength',
    NULL,
    '["Place a balance board in front of you.", "Stand up on it and try to balance yourself.", "Hold the balance for as long as desired."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '96ca0e80-8151-432a-ad61-9d6bee608a6e',
    'com Elástico Good Morning',
    'strength',
    NULL,
    '["Using a 41 inch band, stand on one end, spreading your feet a small amount. Bend at the hips to loop the end of the band behind your neck. This will be your starting position.", "Keeping your legs straight, extend through the hips to come to a near vertical position.", "Ensure that you do not round your back as you go down back to the starting position."]'::jsonb,
    '["bands"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '73c0f06d-f373-489d-84e0-30d3b8476199',
    'com Elástico Good Morning (Pull Through)',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '5707a595-e3df-4b20-8120-aa5d87a2d6b0',
    'com Elástico Skullcrusher',
    'strength',
    'Skullcrusher performed with bands',
    ...
    'ARMS',
    NULL,
    'https://www.youtube.com/watch?v=xtb-gltsmMU'
);
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '5059471d-966a-4c89-9d04-a8759572d3a7',
    'com Halteres Skullcrusher',
    'strength',
    'Skullcrusher performed with dumbbells',
    '["Hold the dumbbells and lay down on a flat bench in such a way that around 1/4 of your head is over the edge.", "Stretch your arms with the weights and bend them so that the dumbbells are lowered (make sure they don't touch each other).", "Just before they touch your forehead, push them up."]'::jsonb,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '49080f21-b327-4efb-bd1d-abf3e88be2e3',
    'com Barra Ab Rollout - On Knees',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '8e58f2ca-fe4c-495d-a754-848fe06f02ba',
    'com Barra Curls Deitado Against An Inclinado',
    'strength',
    NULL,
    '["Lie against an incline bench, with your arms holding a barbell and hanging down in a horizontal line. This will be your starting position.", "While keeping the upper arms stationary, curl the weight up as high as you can while squeezing the biceps. Breathe out as you perform this portion of the movement. Tip: Only the forearms should move. Do not swing the arms.", "After a second contraction, slowly go back to the starting position as you inhale. Tip: Make sure that you go all of the way down.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '4d5b70fe-a703-4797-8f7d-1f0cefdc8386',
    'Levantamento Terra com Barra',
    'strength',
    NULL,
    '["Stand in front of a loaded barbell.", "While keeping the back as straight as possible, bend your knees, bend forward and grasp the bar using a medium (shoulder width) overhand grip. This will be the starting position of the exercise. Tip: If it is difficult to hold on to the bar with this grip, alternate your grip or use wrist straps.", "While holding the bar, start the lift by pushing with your legs while simultaneously getting your torso to the upright position as you breathe out. In the upright position, stick your chest out and contract the back by bringing the shoulder blades back. Think of how the soldiers in the military look when they are in standing in attention.", "Go back to the starting position by bending at the knees while simultaneously leaning the torso forward at the waist while keeping the back straight. When the weights on the bar touch the floor you are back at the starting position and ready to perform another repetition.", "Perform the amount of repetitions prescribed in the program."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'b8089905-aaad-4bbb-829e-9ccf39e6d633',
    'Elevação Inclinado com Barra',
    'strength',
    NULL,
    '["Lie back on an Incline Bench. Using a medium width grip (a grip that is slightly wider than shoulder width), lift the bar from the rack and hold it straight over you with your arms straight. This will be your starting position.", "While keeping the arms straight, lift the bar by protracting your shoulder blades, raising the shoulders from the bench as you breathe out.", "Bring back the bar to the starting position as you breathe in.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '10832c76-3220-412f-82f0-5d6f52e82b67',
    'Elevação Sentado com Barra',
    'strength',
    NULL,
    '["Place a block about 12 inches in front of a flat bench.", "Sit on the bench and place the ball of your feet on the block.", "Have someone place a barbell over your upper thighs about 3 inches above your knees and hold it there. This will be your starting position.", "Raise up on your toes as high as possible as you squeeze the calves and as you breathe out.", "After a second contraction, slowly go back to the starting position. Tip: To get maximum benefit stretch your calves as far as you can.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '29b139cf-d160-405f-a153-909aba53fdd6',
    'Desenvolvimento de Ombros com Barra',
    'strength',
    NULL,
    '["Sit on a bench with back support in a squat rack. Position a barbell at a height that is just above your head. Grab the barbell with a pronated grip (palms facing forward).", "Once you pick up the barbell with the correct grip width, lift the bar up over your head by locking your arms. Hold at about shoulder level and slightly in front of your head. This is your starting position.", "Lower the bar down to the shoulders slowly as you inhale.", "Lift the bar back up to the starting position as you exhale.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '2136de1e-a66b-4592-b801-3d5e1ba0018d',
    'Agachamento Lateral com Barra',
    'strength',
    NULL,
    '["Stand up straight while holding a barbell placed on the back of your shoulders (slightly below the neck). Your feet should be placed wide apart with the foot of the lead leg angled out to the side. This will be your starting position.", "Lower your body towards the side of your angled foot by bending the knee and hip of your lead leg and while keeping the opposite leg only slightly bent. Breathe in as you lower your body.", "Return to the starting position by extending the hip and knee of the lead leg. Breathe out as you perform this movement.", "After performing the recommended amount of reps, repeat the movement with the opposite leg."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'e65f82e4-af33-474d-bc19-cf5f9a779665',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'fc7667e2-fa0c-49c8-a4c2-63f592ccc0ed',
    'Alongamento',
    'stretching',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '13f0fe13-8282-4337-8b9b-7b8cc5ab91c9',
    'Bench Dips',
    'strength',
    'Dips performed on a bench',
    '["For this exercise you will need to place a bench behind your back. With the bench perpendicular to your body, and while looking away from it, hold on to the bench on its edge with the hands fully extended, separated at shoulder width. The legs will be extended forward, bent at the waist and perpendicular to your torso. This will be your starting position.", "Slowly lower your body as you inhale by bending at the elbows until you lower yourself far enough to where there is an angle slightly smaller than 90 degrees between the upper arm and the forearm. Tip: Keep the elbows as close as possible throughout the movement. Forearms should always be pointing down.", "Using your triceps to bring your torso up again, lift yourself back to the starting position.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["bench"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '0bdf7f13-93f6-421f-b680-9e5a4bb25842',
    'Bench Sprint',
    'plyometrics',
    NULL,
    '["Stand on the ground with one foot resting on a bench or box with your heel close to the edge.", "Push off with your foot on top of the bench, extending through the hip and knee.", "Land with the opposite foot on top of the box, returning your other foot back to the start position.", "Continue alternating from one foot to another to complete the set."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '05725933-086f-4367-a1dc-97a024007506',
    'Elevação',
    'strength',
    NULL,
    '["Lay flat on the floor with your arms next to your sides.", "Now bend your knees at around a 75 degree angle and lift your feet off the floor by around 2 inches.", "Using your lower abs, bring your knees in towards you as you maintain the 75 degree angle bend in your legs. Continue this movement until you raise your hips off of the floor by rolling your pelvis backward. Breathe out as you perform this portion of the movement. Tip: At the end of the movement your knees will be over your chest.", "Squeeze your abs at the top of the movement for a second and then return to the starting position slowly as you breathe in. Tip: Maintain a controlled motion at all times.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'fdbae2e4-d47d-46fb-9174-1d1fba2cd210',
    'Curvado Baixo-Pulley Lateral Lateral',
    'strength',
    NULL,
    '["Select a weight and hold the handle of the low pulley with your right hand.", "Bend at the waist until your torso is nearly parallel to the floor. Your legs should be slightly bent with your left hand placed on your lower left thigh. Your right arm should be hanging from your shoulder in front of you and with a slight bend at the elbow. This will be your starting position.", "Raise your right arm, elbow slightly bent, to the side until the arm is parallel to the floor and in line with your right ear. Breathe out as you perform this step.", "Slowly lower the weight back to the starting position as you breathe in.", "Repeat for the recommended amount of repetitions and repeat the movement with the other arm."]'::jsonb,
    '["cable"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f375bd81-6f1c-40bc-8261-e6d7677ab584',
    'Remada Curvado',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '7f34673e-70d1-4742-a033-9805232f1ef2',
    'Remada Curvado com Halteres',
    'strength',
    NULL,
    '["With a dumbbell in each hand (palms facing your torso), bend your knees slightly and bring your torso forward by bending at the waist; as you bend make sure to keep your back straight until it is almost parallel to the floor. Tip: Make sure that you keep the head up. The weights should hang directly in front of you as your arms hang perpendicular to the floor and your torso. This is your starting position.", "While keeping the torso stationary, lift the dumbbells to your side (as you breathe out), keeping the elbows close to the body (do not exert any force with the forearm other than holding the weights). On the top contracted position, squeeze the back muscles and hold for a second.", "Slowly lower the weight again to the starting position as you inhale.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f2886f88-c697-4167-a693-03097d55018e',
    'Remada Curvado com Halteres',
    'strength',
    NULL,
    '["With a dumbbell in each hand (palms facing each other), bend your knees slightly and bring your torso forward, by bending at the waist, while keeping the back straight until it is almost parallel to the floor. Tip: Make sure that you keep the head up. The weights should hang directly in front of you as your arms hang perpendicular to the floor and your torso. This is your starting position.", "While keeping the torso stationary, lift the dumbbells to your side as you breathe out, squeezing your shoulder blades together. On the top contracted position, squeeze the back muscles and hold for a second.", "Slowly lower the weight again to the starting position as you inhale.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '76335ed4-152e-453f-884c-719b032b9bed',
    'Bicycling',
    'cardio',
    NULL,
    '["To begin, seat yourself on the bike and adjust the seat to your height."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '0652dd46-f6c9-4983-bf42-7840366851c5',
    'Bicycling, Stationary',
    'cardio',
    NULL,
    '["To begin, seat yourself on the bike and adjust the seat to your height.", "Select the desired option from the menu. You may have to start pedaling to turn it on. You can use the manual setting, or you can select a program to use. Typically, you can enter your age and weight to estimate the amount of calories burned during exercise. The level of resistance can be changed throughout the workout. The handles can be used to monitor your heart rate to help you stay at an appropriate intensity."]'::jsonb,
    '["machine"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '8bfd5462-4aea-4ad9-9aaa-225bfdebab74',
    'Desenvolvimento',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'bb3fe716-059a-4202-b694-fcab256c48d0',
    'Desenvolvimento',
    'strength',
    NULL,
    '["Position a bar in a rack at chest height.", "Standing, take a shoulder width grip on the bar and step a yard or two back, feet together and arms extended so that you are leaning on the bar. This will be your starting position.", "Begin by flexing the elbow, lowering yourself towards the bar.", "Pause, and then reverse the motion by extending the elbows.", "Progress from bodyweight by adding chains over your shoulders."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'aa457c6e-2e0c-4d14-9490-4d07bd1a55a4',
    'Agachamento',
    'strength',
    NULL,
    '["Stand with your feet shoulder width apart. You can place your hands behind your head. This will be your starting position.", "Begin the movement by flexing your knees and hips, sitting back with your hips.", "Continue down to full depth if you are able,and quickly reverse the motion until you return to the starting position. As you squat, keep your head and chest up and push your knees out."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '7b89848c-9226-479b-87d2-614f811657fe',
    'Afundo',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'dc2ff195-524f-43ff-93ea-c87926ae905f',
    'Clean',
    'strength',
    NULL,
    '["Initiate the exercise by standing upright with a kettlebell in one hand.", "Swing the kettlebell back forcefully and then reverse the motion forcefully. Crush the kettlebell handle as hard as possible and raise the kettlebell to your shoulder."]'::jsonb,
    '["kettlebell"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'c82b0daa-e758-4f9b-a2a9-d49c415a2d1c',
    'Agachamento',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '5808f92f-deec-43c9-ae4e-ab09ce2c6508',
    'Agachamento',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '22d688ff-6365-47c7-8605-ac1dc9e48fd9',
    'na Polia Inclinado Pushdown',
    'strength',
    NULL,
    '["Lie on incline an bench facing away from a high pulley machine that has a straight bar attachment on it.", "Grasp the straight bar attachment overhead with a pronated (overhand; palms down) shoulder width grip and extend your arms in front of you. The bar should be around 2 inches away from your upper thighs. This will be your starting position.", "Keeping the upper arms stationary, lift your arms back in a semi circle until the bar is straight over your head. Breathe in during this portion of the movement.", "Slowly go back to the starting position using your lats and hold the contraction once you reach the starting position. Breathe out during the execution of this movement.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["cable"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'e091ab28-a0e8-468f-8249-302e0ca733d0',
    'na Polia Internal Rotation',
    'strength',
    NULL,
    '["Sit next to a low pulley sideways (with legs stretched in front of you or crossed) and grasp the single hand cable attachment with the arm nearest to the cable. Tip: If you can adjust the pulley height, you can use a flat bench to sit on instead.", "Position the elbow against your side with the elbow bent at 90 and the arm pointing towards the pulley. This will be your starting position.", "Pull the single hand cable attachment toward your body by internally rotating your shoulder until your forearm is across your abs. You will be creating an imaginary semi-circle. Tip: The forearm should be perpendicular to your torso at all times.", "Slowly go back to the initial position.", "Repeat for the recommended amount of repetitions and then repeat the movement with the next arm."]'::jsonb,
    '["cable"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '6ffd625f-087b-446f-a6c3-79befb77d1b0',
    'na Polia Judo Flip',
    'strength',
    NULL,
    '["Connect a rope attachment to a tower, and move the cable to the lowest pulley position. Stand with your side to the cable with a wide stance, and grab the rope with both hands.", "Twist your body away from the pulley as you bring the rope over your shoulder like you performing a judo flip.", "Shift your weight between your feet as you twist and crunch forward, pulling the cable downward.", "Return to the starting position and repeat until failure.", "Then, reposition and repeat the same series of movements on the opposite side."]'::jsonb,
    '["cable"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '8eefd270-c169-4158-a9c7-dbfb473619a2',
    'Rosca na Polia',
    'strength',
    NULL,
    '["Place a preacher bench about 2 feet in front of a pulley machine.", "Attach a straight bar to the low pulley.", "Sit at the preacher bench with your elbow and upper arms firmly on top of the bench pad and have someone hand you the bar from the low pulley.", "Grab the bar and fully extend your arms on top of the preacher bench pad. This will be your starting position.", "Now start pilling the weight up towards your shoulders and squeeze the biceps hard at the top of the movement. Exhale as you perform this motion. Also, hold for a second at the top.", "Now slowly lower the weight to the starting position.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["cable"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '0ff6396f-9d9f-4a74-affe-77cbbb5fa123',
    'Abdominal Inverso na Polia',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ae7c8277-b026-482d-9553-1da87e007d3f',
    'na Polia Russian Twists',
    'strength',
    NULL,
    '["Connect a standard handle attachment, and position the cable to a middle pulley position.", "Lie on a stability ball perpendicular to the cable and grab the handle with one hand. You should be approximately arm length away from the pulley, with the tension of the weight on the cable.", "Grab the handle with both hands and fully extend your arms above your chest. You hands should be directly in-line with the pulley. If not, adjust the pulley up or down until they are.", "Keep your hips elevated and abs engaged. Rotate your torso away from the pulley for a full-quarter rotation. Your body should be flat from head to knees.", "Pause for a moment and in a slow and controlled manner reset to the starting position. You should still have side tension on the cable in the resting position.", "Repeat the same movement to failure.", "Then, reposition and repeat the same series of movements on the opposite side."]'::jsonb,
    '["cable"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '94a137ae-43e5-47a1-9b9b-74223180901c',
    'Desenvolvimento de Ombros na Polia',
    'strength',
    NULL,
    '["Move the cables to the bottom of the towers and select an appropriate weight.", "Stand directly in between the uprights. Grasp the cables and hold them at shoulder height, palms facing forward. This will be your starting position.", "Keeping your head and chest up, extend through the elbow to press the handles directly over head.", "After pausing at the top, return to the starting position and repeat."]'::jsonb,
    '["cable"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '4abdd9d3-b533-4fe7-9667-c98052c838e8',
    'na Polia Shrugs',
    'strength',
    NULL,
    '["Grasp a cable bar attachment that is attached to a low pulley with a shoulder width or slightly wider overhand (palms facing down) grip.", "Stand erect close to the pulley with your arms extended in front of you holding the bar. This will be your starting position.", "Lift the bar by elevating the shoulders as high as possible as you exhale. Hold the contraction at the top for a second. Tip: The arms should remain extended at all times. Refrain from using the biceps to help lift the bar. Only the shoulders should be moving up and down.", "Lower the bar back to the original position.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["cable"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '2950d55e-c840-4b46-b0a0-cb51cdb196e0',
    'Encolhimento na Máquina',
    'strength',
    NULL,
    '["Position yourself on the calf machine so that the shoulder pads are above your shoulders. Your torso should be straight with the arms extended normally by your side. This will be your starting position.", "Raise your shoulders up towards your ears as you exhale and hold the contraction for a full second.", "Slowly return to the starting position as you inhale.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["machine"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '1858f91d-3372-4499-b538-dc3108ff303b',
    'Alongamento',
    'stretching',
    NULL,
    '["Stand facing a wall from a couple feet away.", "Lean against the wall, placing your weight on your forearms.", "Attempt to keep your heels on the ground. Hold for 10-20 seconds. You may move further or closer the wall, making it more or less difficult, respectively."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '92ca56d4-c9a3-4994-aa91-3654154af4df',
    'Alongamento',
    'stretching',
    NULL,
    '["Stand facing a wall from several feet away. Stagger your stance, placing one foot forward.", "Lean forward and rest your hands on the wall, keeping your heel, hip and head in a straight line.", "Attempt to keep your heel on the ground. Hold for 10-20 seconds and then switch sides."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'd6e80fdb-affa-48bb-a5cf-23e32e84fb2f',
    'Levantamento Terra',
    'strongman',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '93cb19d0-896a-43e5-9c57-f7731026035c',
    'Car Drivers',
    'strength',
    NULL,
    '["While standing upright, hold a barbell plate in both hands at the 3 and 9 o'clock positions. Your palms should be facing each other and your arms should be extended straight out in front of you. This will be your starting position.", "Initiate the movement by rotating the plate as far to one side as possible. Use the same type of movement you would use to turn a steering wheel to one side.", "Reverse the motion, turning it all the way to the opposite side.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '0bad0ee0-2c1c-437f-852f-bc8ad1f19c9e',
    'Carioca Quick Step',
    'plyometrics',
    NULL,
    '["Begin with your feet a few inches apart and your left arm up in a relaxed, athletic position.", "With your right foot, quick step behind and pull the knee up.", "Fire your arms back up when you pull the right knee, being sure that your knee goes straight up and down. Avoid turning your feet as you move and continue to look forward as you move to the side."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'b8ef08a5-7c37-4056-90d8-10f150d6d52a',
    'Alongamento',
    'stretching',
    NULL,
    '["Position yourself on the floor on your hands and knees.", "Pull your belly in and round your spine, lower back, shoulders, and neck, letting your head drop.", "Hold for 15 seconds."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'd507aee3-4865-419d-b096-cab5bfb7b01e',
    'Catch and Acima da Cabeça Throw',
    'plyometrics',
    NULL,
    '["Begin standing while facing a wall or a partner.", "Using both hands, position the ball behind your head, stretching as much as possible, and forcefully throw the ball forward.", "Ensure that you follow your throw through, being prepared to receive your rebound from your throw. If you are throwing against the wall, make sure that you stand close enough to the wall to receive the rebound, and aim a little higher than you would with a partner."]'::jsonb,
    '["medicine ball"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '57e12ffc-5e5e-46e1-9249-2a22699a7f1f',
    'Alongamento',
    'stretching',
    NULL,
    '["Sit upright in a chair and grip the seat on the sides.", "Raise one leg, extending the knee, flexing the ankle as you do so.", "Slowly move that leg outward as far as you can, and then back to the center and down.", "Repeat for your other leg."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'c13e061a-1fdf-42ad-ae1a-c90e6506ed29',
    'Alongamento',
    'stretching',
    NULL,
    '["Sit upright on a chair.", "Bend to one side with your arm over your head. You can hold onto the chair with your free hand.", "Hold for 10 seconds, and repeat for your other side."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '4a523384-9cd0-40fb-9334-29ebdf399276',
    'Alongamento',
    'stretching',
    NULL,
    '["Sit on the edge of a chair, gripping the back of it.", "Straighten your arms, keeping your back straight, and pull your upper body forward so you feel a stretch. Hold for 20-30 seconds."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '24b725d8-a0f2-427f-a307-d22cf949d491',
    'Alongamento Frontal',
    'stretching',
    NULL,
    '["Start off by standing with your legs together, holding a bodybar or a broomstick.", "Take a slightly wider than shoulder width grip on the pole and hold it in front of you with your palms facing down.", "Carefully lift the pole up and behind your head."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'CHEST',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '79e15a62-17d8-453b-bc15-30a79956c2ed',
    'Peito Push (multiple response)',
    'plyometrics',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'bdd2ed9d-d1f0-41a9-82fb-2a6774739a9a',
    'Peito Push (single response)',
    'plyometrics',
    NULL,
    '["Begin in a kneeling position holding the medicine ball with both hands tightly into the chest.", "Execute the pass by exploding forward and outward with the hips while pushing the ball as far as possible.", "Follow through by falling forward, catching yourself with your hands."]'::jsonb,
    '["medicine ball"]'::jsonb,
    FALSE,
    'CHEST',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'e1fa8c13-f49d-4bd0-92c7-d6c03daffe53',
    'Peito Push with Run Release',
    'plyometrics',
    NULL,
    '["Begin in an athletic stance with the knees bent, hips back, and back flat. Hold the medicine ball near your legs. This will be your starting position.", "While taking your first step draw the medicine ball into your chest.", "As you take the second step, explosively push the ball forward, immediately sprinting for 10 yards after the release. If you are really fast, you can catch your own pass!"]'::jsonb,
    '["medicine ball"]'::jsonb,
    FALSE,
    'CHEST',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '4cd1c1b6-a216-4b42-8e2a-b032159000d9',
    'Child''s Pose',
    'stretching',
    NULL,
    '["Get on your hands and knees, walk your hands in front of you.", "Lower your buttocks down to sit on your heels. Let your arms drag along the floor as you sit back to stretch your entire spine.", "Once you settle onto your heels, bring your hands next to your feet and relax. breathe into your back. Rest your forehead on the floor. Avoid this position if you have knee problems."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'bbe373cc-e4f6-4731-bd88-182f9065c659',
    'Alongamento',
    'stretching',
    NULL,
    '["Get into a seated position on the floor.", "Place both hands at the rear of your head, fingers interlocked, thumbs pointing down and elbows pointing straight ahead. Slowly pull your head down to your chest. Hold for 20-30 seconds."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    NULL,
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '10f5dfd2-72db-4814-9744-f3006e09b6d3',
    'Clean',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '01710c1c-8ac5-4cfb-ab2d-2588960f6cfb',
    'Encolhimento',
    'olympic weightlifting',
    NULL,
    '["Begin with a shoulder width, double overhand or hook grip, with the bar hanging at the mid thigh position. Your back should be straight and inclined slightly forward.", "Shrug your shoulders towards your ears. While this exercise can usually by loaded with heavier weight than a clean, avoid overloading to the point that the execution slows down."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'aafaf5e4-6107-4248-8c1e-5d381bd40245',
    'Arremesso',
    'olympic weightlifting',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '61f2fb34-2d29-4478-842c-62b2e562b5d2',
    'Desenvolvimento',
    'strength',
    NULL,
    '["Assume a shoulder-width stance, with knees inside the arms. Now while keeping the back flat, bend at the knees and hips so that you can grab the bar with the arms fully extended and a pronated grip that is slightly wider than shoulder width. Point the elbows out to sides. The bar should be close to the shins. Position the shoulders over or slightly ahead of the bar. Establish a flat back posture. This will be your starting position.", "Begin to pull the bar by extending the knees. Move your hips forward and raise the shoulders at the same rate while keeping the angle of the back constant; continue to lift the bar straight up while keeping it close to your body.", "As the bar passes the knee, extend at the ankles, knees, and hips forcefully, similar to a jumping motion. As you do so, continue to guide the bar with your hands, shrugging your shoulders and using the momentum from your movement to pull the bar as high as possible. The bar should travel close to your body, and you should keep your elbows out.", "At maximum elevation, your feet should clear the floor and you should start to pull yourself under the bar. The mechanics of this could change slightly, depending on the weight used. You should descend into a squatting position as you pull yourself under the bar.", "As the bar hits terminal height, rotate your elbows around and under the bar. Rack the bar across the front of the shoulders while keeping the torso erect and flexing the hips and knees to absorb the weight of the bar.", "Stand to full height, holding the bar in the clean position.", "Without moving your feet, press the bar overhead as you exhale. Lower the bar under control ."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '5c51fb83-a2a9-4c74-90ca-8e3942a77ad6',
    'Supino com Barra',
    'strength',
    'Flat bench press performed with a close grip on a barbell',
    ...
    'ARMS',
    NULL,
    'https://www.youtube.com/watch?v=XEnAUu6WtSw'
);
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f9c5f3a6-cf81-4161-a9ce-35cad4d4fab3',
    'Desenvolvimento com Halteres',
    'strength',
    NULL,
    '["Place a dumbbell standing up on a flat bench.", "Ensuring that the dumbbell stays securely placed at the top of the bench, lie perpendicular to the bench with only your shoulders lying on the surface. Hips should be below the bench and your legs bent with your feet firmly on the floor.", "Grasp the dumbbell with both hands and hold it straight over your chest at arm length. Both palms should be pressing against the underside of the sides of the dumbbell. This will be your starting position.", "Initiate the movement by lowering the dumbbell to your chest.", "Return to the starting position by extending the elbows."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '271cb309-3ccf-4640-8ade-0aebf235a943',
    'Rosca com Elástico',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '3a5d2563-0a0b-438a-a5cc-3fa66ea69b8f',
    'Rosca',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '8c9fc7c3-2534-4737-a593-8b9206d5f576',
    'Rosca Martelo',
    'strength',
    'Hammer curl performed with dumbbells across the body',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'a79f9a94-6b9e-424c-97d0-7ccb14d536e3',
    'Afundo Inverso',
    'stretching',
    NULL,
    '["Stand with your feet shoulder width apart. This will be your starting position.", "Perform a rear lunge by stepping back with one foot and flexing the hips and front knee. As you do so, rotate your torso across the front leg.", "After a brief pause, return to the starting position and repeat on the other side, continuing in an alternating fashion."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '693481d6-e218-4350-94b6-67bdbfb341b5',
    'Crucifix',
    'strongman',
    NULL,
    '["In the crucifix, you statically hold weights out to the side for time. While the event can be practiced using dumbbells, it is best to practice with one of the various implements used, such as axes and hammers, as it feels different.", "Begin standing, and raise your arms out to the side holding the implements. Your arms should be parallel to the ground. In competition, judges or sensors are used to let you know when you break parallel. Hold for as long as you can. Typically, the weights should be heavy enough that you fail in 30-60 seconds."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'a81d1448-4cbd-4c7d-b619-9ec84efa4b8f',
    'Abdominal com Bola',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'c71af8e2-8eb9-4058-8d4a-7d6cd15d69ba',
    'Alongamento',
    'stretching',
    NULL,
    '["Sit up on the floor.", "Cross your right leg over your left, keeping the knee bent. Your left leg is straight and down on the floor.", "Place your left arm on your right leg and your right hand on the floor.", "Rotate your upper body to the right, and hold for 10-20 seconds. Switch sides."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'b2234055-1aa1-4003-b5a8-b9e2f9494995',
    'Levantamento Terra',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '92c03f3c-dbc8-4c5d-b0a8-d1c812d3aa1c',
    'Levantamento Terra',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ab7f70a6-b0eb-402a-830e-736f79ab5d8e',
    'Supino Declinado com Barra',
    'strength',
    'Decline bench press performed with a medium grip on a barbell',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'be0a3e03-8888-4be9-825c-b9f6fe82878d',
    'Abdominal Declinado',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '93bbd1a5-2eb5-4212-a5d5-6d6a8f387a7a',
    'Extensão de Tríceps Declinado com Halteres',
    'strength',
    NULL,
    '["Secure your legs at the end of the decline bench and lie down with a dumbbell on each hand on top of your thighs. The palms of your hand will be facing each other.", "Once you are laying down, move the dumbbells in front of you at shoulder width. The palms of the hands should be facing each other and the arms should be perpendicular to the floor and fully extended. This will be your starting position.", "As you breathe in and you keep the upper arms stationary (and elbows in), bring the dumbbells down slowly by moving your forearms in a semicircular motion towards you until your thumbs are next to your ears. Breathe in as you perform this portion of the movement.", "Lift the dumbbells back to the starting position by contracting the triceps and exhaling.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '4d7ccce9-d4c3-4f82-a590-2ab8e9cb86b5',
    'Desenvolvimento Declinado no Smith',
    'strength',
    NULL,
    '["Place a decline bench underneath the Smith machine. Now place the barbell at a height that you can reach when lying down and your arms are almost fully extended. Using a pronated grip that is wider than shoulder width, unlock the bar from the rack and hold it straight over you with your arms extended. This will be your starting position.", "As you inhale, lower the bar under control by allowing the elbows to flex, lightly contacting the torso.", "After a brief pause, bring the bar back to the starting position by extending the elbows, exhaling as you do so.", "Repeat the movement for the prescribed amount of repetitions.", "When the set is complete, lock the bar back in the rack."]'::jsonb,
    '["machine"]'::jsonb,
    FALSE,
    'CHEST',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '9d4d7e28-d16d-4929-a8fc-35dd7a975361',
    'Levantamento Terra',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '2d5631ae-a8c5-415a-9452-1140b0a6d5ca',
    'Dips (Peito Focus)',
    'strength',
    'Dips with a chest focus performed on parallel bars (or similar)',
    '["For this exercise you will need access to parallel bars. To get yourself into the starting position, hold your body at arms length (arms locked) above the bars.", "While breathing in, lower yourself slowly with your torso leaning forward around 30 degrees or so and your elbows flared out slightly until you feel a slight stretch in the chest.", "Once you feel the stretch, use your chest to bring your body back to the starting position as you breathe out. Tip: Remember to squeeze the chest at the top of the movement for a second.", "Repeat the movement for the prescribed amount of repetitions."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'CHEST',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'cb8ed9e7-a86d-4c9e-956d-149e83b7bbf0',
    'Donkey Panturrilha Raises',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '9e5c1ee8-e30a-494f-b92e-04ad316d9b35',
    'Clean Alternado com Kettlebell',
    'strength',
    NULL,
    '["Place two kettlebells between your feet. To get in the starting position, push your butt back and look straight ahead.", "Clean one kettlebell to your shoulder and hold on to the other kettlebell.", "With a fluid motion, lower the top kettlebell while driving the bottom kettlebell up."]'::jsonb,
    '["kettlebell"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '6cdc2212-5838-4ef7-b4ba-df4e097bd02c',
    'Desenvolvimento com Kettlebell',
    'strength',
    NULL,
    '["Clean two kettlebells to your shoulders.", "Squat down a few inches and reverse the motion rapidly. Use the momentum from the legs to drive the kettlebells overhead.", "Once the kettlebells are locked out, lower the kettlebells to your shoulders and repeat."]'::jsonb,
    '["kettlebell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'cabec12f-00ab-4a57-92d6-7fc2145585c6',
    'Snatch com Kettlebell',
    'strength',
    NULL,
    '["Place two kettlebells behind your feet. Bend your knees and sit back to pick up the kettlebells.", "Swing the kettlebells between your legs forcefully and reverse the direction.", "Drive through with your hips and lock the ketttlebells overhead in one uninterrupted motion."]'::jsonb,
    '["kettlebell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'fbe0b692-8730-44c0-92fd-d26137a97162',
    'Downward Facing Balance',
    'strength',
    NULL,
    '["Lie facedown on top of an exercise ball.", "While resting on your stomach on the ball, walk your hands forward along the floor and lift your legs, extending your elbows and knees."]'::jsonb,
    '["exercise ball"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'd3e99163-8790-4d5a-ba6c-52e6690c0acf',
    'Drop Push',
    'plyometrics',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '27077ffe-e895-4d69-8c8f-b5e60f49c8c9',
    'Supino com Halteres',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '556adb65-3ed4-455a-ab6a-ad69e790b2de',
    'Rosca com Halteres',
    'strength',
    'A biceps curl performed with dumbbells',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '7f37e39f-d498-4e38-98cc-1f4b588556c4',
    'Desenvolvimento no Chão com Halteres',
    'strength',
    NULL,
    '["Lay on the floor holding dumbbells in your hands. Your knees can be bent. Begin with the weights fully extended above you.", "Lower the weights until your upper arm comes in contact with the floor. You can tuck your elbows to emphasize triceps size and strength, or to focus on your chest angle your arms to the side.", "Pause at the bottom, and then bring the weight together at the top by extending through the elbows."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '26324afc-3fdf-4988-bbbb-7841a197f78f',
    'com Halteres Flyes',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '81f4e2bd-7ad3-4b03-9f9c-ef2624fe03e6',
    'Remada Inclinado com Halteres',
    'strength',
    NULL,
    '["Using a neutral grip, lean into an incline bench.", "Take a dumbbell in each hand with a neutral grip, beginning with the arms straight. This will be your starting position.", "Retract the shoulder blades and flex the elbows to row the dumbbells to your side.", "Pause at the top of the motion, and then return to the starting position."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '7eb892c8-916b-4e62-89d1-9518b6aeb6d2',
    'Elevação Inclinado com Halteres',
    'strength',
    NULL,
    '["Sit on an Incline Bench while holding a dumbbell on each hand on top of your thighs.", "Lift your legs up to kick the weights to your shoulders and lean back. Position the dumbbells above your shoulders with your arms extended. The arms should be perpendicular to the floor with your palms facing forward and knuckles pointing towards the ceiling. This will be your starting position.", "While keeping the arms straight and locked, lift the dumbbells by raising the shoulders from the bench as you breathe out.", "Bring back the dumbbells to the starting position as you breathe in.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'bbda4061-5ff3-47a4-9d6c-57319b0f3458',
    'com Halteres Lunges',
    'strength',
    NULL,
    '["Stand with your torso upright holding two dumbbells in your hands by your sides. This will be your starting position.", "Step forward with your right leg around 2 feet or so from the foot being left stationary behind and lower your upper body down, while keeping the torso upright and maintaining balance. Inhale as you go down. Note: As in the other exercises, do not allow your knee to go forward beyond your toes as you come down, as this will put undue stress on the knee joint. Make sure that you keep your front shin perpendicular to the ground.", "Using mainly the heel of your foot, push up and go back to the starting position as you exhale.", "Repeat the movement for the recommended amount of repetitions and then perform with the left leg."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ac7c7327-2671-48c2-a1df-6879ef1334a2',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '2b3d870f-7d4d-4bd6-af3e-055034834428',
    'Remada com Halteres',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '32871d51-afc7-402f-804e-230ae4123982',
    'Elevação com Halteres',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'e599423d-d145-4243-b8e4-feaea1033c34',
    'com Halteres Scaption',
    'strength',
    NULL,
    '["This corrective exercise strengthens the muscles that stabilize your shoulder blade. Hold a light weight in each hand, hanging at your sides. Your thumbs should pointing up.", "Begin the movement raising your arms out in front of you, about 30 degrees off center. Your arms should be fully extended as you perform the movement.", "Continue until your arms are parallel to the ground, and then return to the starting position."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '2accb8de-9f9d-4651-b72d-c763b3405c67',
    'Salto Sentado com Halteres',
    'plyometrics',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '3fa5e9f4-9f03-4fb6-8ea0-3458aa052fa7',
    'Elevação Sentado com Halteres',
    'strength',
    NULL,
    '["Place a block on the floor about 12 inches from a flat bench.", "Sit on a flat bench and place a dumbbell on your upper left thigh about 3 inches above your knee.", "Now place the ball of your left foot on the block. This will be your starting position.", "Raise your toes up as high as possible as you exhale and you contract your calf muscle. Hold the contraction for a second.", "Slowly return to the starting position, stretching as far down as possible.", "Repeat for your prescribed number of repetitions and then repeat with the right leg."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '964d715f-eb99-4270-a1e8-bd30040e372c',
    'Encolhimento com Halteres',
    'strength',
    NULL,
    '["Stand erect with a dumbbell on each hand (palms facing your torso), arms extended on the sides.", "Lift the dumbbells by elevating the shoulders as high as possible while you exhale. Hold the contraction at the top for a second. Tip: The arms should remain extended at all times. Refrain from using the biceps to help lift the dumbbells. Only the shoulders should be moving up and down.", "Lower the dumbbells back to the original position.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '198e6073-b613-4f72-bd27-44db3b41f689',
    'com Halteres Lateral Bend',
    'strength',
    NULL,
    '["Stand up straight while holding a dumbbell on the left hand (palms facing the torso) as you have the right hand holding your waist. Your feet should be placed at shoulder width. This will be your starting position.", "While keeping your back straight and your head up, bend only at the waist to the right as far as possible. Breathe in as you bend to the side. Then hold for a second and come back up to the starting position as you exhale. Tip: Keep the rest of the body stationary.", "Now repeat the movement but bending to the left instead. Hold for a second and come back to the starting position.", "Repeat for the recommended amount of repetitions and then change hands."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f4186884-a4f8-4f44-bb45-fa2089811ce3',
    'com Halteres Step Ups',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '8d463fb1-c1e3-4f56-8d64-e5d972801279',
    'Alongamento',
    'stretching',
    NULL,
    '["Stand with your feet shoulder width apart. This will be your starting position.", "Keeping your arms straight, swing them straight up in front of you 5-10 times, increasing the range of motion each time until your arms are above your head."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '32bcbdb3-2c64-4dcf-9e0b-821ae9741d02',
    'Alongamento',
    'stretching',
    NULL,
    '["Stand with your hands together, arms extended directly in front of you. This will be your starting position.", "Keeping your arms straight, quickly move your arms back as far as possible and back in again, similar to an exaggerated clapping motion. Repeat 5-10 times, increasing speed as you do so."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'CHEST',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'bc51212e-ec36-4d3e-976c-50b1e8e8cb2b',
    'EZ-Bar Skullcrusher',
    'strength',
    'Skullcrusher performed with an ez-bar',
    '["Using a close grip, lift the EZ bar and hold it with your elbows in as you lie on the bench. Your arms should be perpendicular to the floor. This will be your starting position.", "Keeping the upper arms stationary, lower the bar by allowing the elbows to flex. Inhale as you perform this portion of the movement. Pause once the bar is directly above the forehead.", "Lift the bar back to the starting position by extending the elbow and exhaling.", "Repeat."]'::jsonb,
    '["ez curl bar", "bench"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f570e262-8a4a-422e-912d-42faf415c50e',
    'Rotação',
    'stretching',
    NULL,
    '["Sit or stand with your feet slightly apart.", "Place your hands on your shoulders with your elbows at shoulder level and pointing out.", "Slowly make a circle with your elbows. Breathe out as you start the circle and breathe in as you complete the circle."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'c186b43a-5bf3-4823-b83a-960675419f53',
    'Elbow to Knee',
    'strength',
    NULL,
    '["Lie on the floor, crossing your right leg across your bent left knee. Clasp your hands behind your head, beginning with your shoulder blades on the ground. This will be your starting position.", "Perform the motion by flexing the spine and rotating your torso to bring the left elbow to the right knee.", "Return to the starting position and repeat the movement for the desired number of repetitions before switching sides."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '3488de23-344b-43cc-b317-fa340f524682',
    'Elbows Back',
    'stretching',
    NULL,
    '["Stand up straight.", "Place both hands on your lower back, fingers pointing downward and elbows out.", "Then gently pull your elbows back aiming to touch them together."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'CHEST',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'a870403f-c57b-4d79-87a6-12d78a5e46ed',
    'Elliptical Trainer',
    'cardio',
    NULL,
    '["To begin, step onto the elliptical and select the desired option from the menu. Most ellipticals have a manual setting, or you can select a program to run. Typically, you can enter your age and weight to estimate the amount of calories burned during exercise. Elevation can be adjusted to change the intensity of the workout.", "The handles can be used to monitor your heart rate to help you stay at an appropriate intensity."]'::jsonb,
    '["machine"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'b3b381f1-402b-470e-9f7c-30eaa8799d5b',
    'External Rotation',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '0c522188-9342-4f43-9f8c-8b72f941751c',
    'Face Pull',
    'strength',
    NULL,
    '["Facing a high pulley with a rope or dual handles attached, pull the weight directly towards your face, separating your hands as you do so. Keep your upper arms parallel to the ground."]'::jsonb,
    '["cable"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '799891f2-043d-4943-a036-fd22177d73a9',
    'Fast Skipping',
    'plyometrics',
    NULL,
    '["Start in a relaxed position with one leg slightly forward. This will be your starting position.", "Skip by executing a step-hop pattern of right-right-step to left-left-step, and so on, alternating back and forth.", "Perform fast skips by maintaining close contact with the ground and reduce air time, moving as quickly as possible."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '6de37fae-e79c-43fd-b0c6-efb85ec989c3',
    'Elevação Reto Deitado',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '595dd926-b64b-4312-861c-8d938aa0dacb',
    'Elevação no Chão',
    'strength',
    NULL,
    '["You can use a partner for this exercise or brace your feet under something stable.", "Begin on your knees with your upper legs and torso upright. If using a partner, they will firmly hold your feet to keep you in position. This will be your starting position.", "Lower yourself by extending at the knee, taking care to NOT flex the hips as you go forward.", "Place your hands in front of you as you reach the floor. This movement is very difficult and you may be unable to do it unaided. Use your arms to lightly push off the floor to aid your return to the starting position."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'c05d88ca-5707-46f3-9d9f-dd43e3e86e7e',
    'Desenvolvimento no Chão',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '145714e5-46a5-4aed-a731-f88fba2699af',
    'Foot-SMR',
    'stretching',
    NULL,
    '["This exercise stretches the fascia of the muscles in the feet. Start off seated with your shoes removed. Using a foot roller or a similar object, such as a small section of pvc pipe, place your foot against the roller across the arch of your foot. This will be your starting position.", "Press down firmly, rolling across the arch of your foot. Hold for 10-30 seconds, and then switch feet."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '57624fac-2507-4038-8117-4b0f881af50b',
    'Agachamento',
    'strength',
    NULL,
    '["Cross your arms over your chest.", "With your head up and your back straight, position your feet at shoulder width.", "Keeping your back straight and chest up, squat down as you inhale until your upper thighs are parallel, or lower, to the floor.", "Now pressing mainly with the ball of your feet, jump straight up in the air as high as possible, using the thighs like springs. Exhale during this portion of the movement.", "When you touch the floor again, immediately squat down and jump again.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '3c35ce5f-66ed-43d1-9a98-cf148a6d8894',
    'Agachamento Frontal com Barra',
    'strength',
    NULL,
    '["This exercise is best performed inside a squat rack for safety purposes. To begin, first set a flat bench behind you and set the bar on a rack that best matches your height. Once the correct height is chosen and the bar is loaded, bring your arms up under the bar while keeping the elbows high and the upper arm slightly above parallel to the floor. Rest the bar on top of the deltoids and cross your arms while grasping the bar for total control.", "Lift the bar off the rack by first pushing with your legs and at the same time straightening your torso.", "Step away from the rack and position your legs using a shoulder width medium stance with the toes slightly pointed out. Keep your head up at all times as looking down will get you off balance and also maintain a straight back. This will be your starting position. (Note: For the purposes of this discussion we will use the medium stance described above which targets overall development; however you can choose any of the three stances described in the foot positioning section).", "Begin to slowly lower the bar by bending the knees as you maintain a straight posture with the head up. Continue down until you touch the bench with your glutes. Inhale as you perform this portion of the movement. Tip: If you performed the exercise correctly, the front of the knees should make an imaginary straight line with the toes that is perpendicular to the front. If your knees are past that imaginary line (if they are past your toes) then you are placing undue stress on the knee and the exercise has been performed incorrectly.", "Begin to raise the bar as you exhale by pushing the floor mainly with the heel of your foot as you straighten the legs again and go back to the starting position.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'dbc44f78-9f24-431b-89c9-1b1265b6f8bb',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ad9025aa-0b75-4c4d-937a-bd48566e50a5',
    'Elevação Inclinado Frontal com Halteres',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'a5c45d94-3c23-41ab-9681-015b393bcb5a',
    'Frontal Leg Raises',
    'stretching',
    NULL,
    '["Stand next to a chair or other support, holding on with one hand.", "Swing your leg forward, keeping the leg straight. Continue with a downward swing, bringing the leg as far back as your flexibility allows. Repeat 5-10 times, and then switch legs."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'e21c3c7a-d8ee-4b54-becd-fed1554e70f2',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'fea8a746-f3ae-401b-9ec0-355ba7a750bb',
    'Agachamento Frontal',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '8b15eec3-43bd-43c0-95cc-23bef9090d3e',
    'Frontal Squats With Two Kettlebells',
    'strength',
    NULL,
    '["Clean two kettlebells to your shoulders. Clean the kettlebells to your shoulders by extending through the legs and hips as you pull the kettlebells towards your shoulders. Rotate your wrists as you do so.", "Looking straight ahead at all times, squat as low as you can and pause at the bottom. As you squat down, push your knees out. You should squat between your legs, keeping an upright torso, with your head and chest up.", "Rise back up by driving through your heels and repeat."]'::jsonb,
    '["kettlebell"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '09590c13-f7ca-4117-b208-2b405b88156a',
    'Elevação Frontal com Halteres',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '2b34144d-fd99-4722-b10b-60e14c0828cf',
    'Good Morning off Pins',
    'strength',
    NULL,
    '["Begin with a bar on a rack at about the same height as your stomach. Bend over underneath the bar and rack the bar across the rear of your shoulders as you would a power squat, not on top of your shoulders. At the proper height, you should be near parallel to the floor when bent over. Keep your back tight, shoulder blades pinched together, and your knees slightly bent. Keep your back arched and your cervical spine in proper alignment.", "Begin the motion by extending through the hips with your glutes and hamstrings, and you are standing with the weight. Slowly lower the weight back to the pins returning to the starting position."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '3d2e962b-35d4-4326-966e-1db1c580fb48',
    'Alongamento',
    'stretching',
    NULL,
    '["Sit on the floor with your knees bent and feet together.", "Interlock your fingers behind your head. This will be your starting position.", "Curl downwards, bringing your elbows to the inside of your thighs. After a brief pause, return to the starting position with your head up and your back straight. Repeat for 10-20 repetitions."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '483346c9-58cc-46cb-a3e7-99cde74e3278',
    'Groiners',
    'stretching',
    NULL,
    '["Begin in a pushup position on the floor. This will be your starting position.", "Using both legs, jump forward landing with your feet next to your hands. Keep your head up as you do so.", "Return to the starting position and immediately repeat the movement, continuing for 10-20 repetitions."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '59ab684a-d0ac-48e6-8ce9-67fce5c716d4',
    'Rosca Martelo',
    'strength',
    'Hammer curl performed with dumbbells',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '700ee96c-17d5-4b52-82da-99f188fb60e2',
    'Posterior de Coxa-SMR',
    'stretching',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '3aee2fec-8b5b-4437-8ac5-e2c58fd5965d',
    'Clean',
    'olympic weightlifting',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '81710d0d-ac13-4b92-8d7e-b2345c499f39',
    'Clean',
    'olympic weightlifting',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'eb949639-67a3-42f0-8c32-e9d9b21eb960',
    'Hanging Bar Good Morning',
    'strength',
    NULL,
    '["Begin with a bar on a rack at about the same height as your stomach. Suspend the bar using chains or suspension straps.", "Bend over underneath the bar and rack the bar across the rear of your shoulders as you would a power squat, not on top of your traps. At the proper height, you should be near parallel to the floor when bent over. Keep your back tight, shoulder blades pinched together, and your knees slightly bent. Keep your back arched and your cervical spine in proper alignment.", "Begin the motion by extending through the hips with your glutes and hamstrings, and you are standing with the weight.", "Slowly lower the weight back to the starting position, where it is supported by the chains."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'a13a3fbc-8237-455e-9465-5e58dc742c39',
    'Snatch',
    'olympic weightlifting',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'fc8ea6d9-0660-46de-b48a-0a8a1214652b',
    'Hip Flexion with com Elástico',
    'strength',
    NULL,
    '["Secure one end of the band to the lower portion of a post and attach the other to one ankle.", "Face away from the attachment point of the band.", "Keeping your head and your chest up, raise your knee up to 90 degrees and pause.", "Return the leg to the starting position."]'::jsonb,
    '["bands"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ceca86c0-1705-4674-b6a0-cddcb2db465b',
    'Hip Lift with com Elástico',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ba4fb0ce-b21e-42d9-b004-404929f818c8',
    'Hug Knees To Peito',
    'stretching',
    NULL,
    '["Lie down on your back and pull both knees up to your chest.", "Hold your arms under the knees, not over (that would put to much pressure on your knee joints).", "Slowly pull the knees toward your shoulders. This also stretches your buttocks muscles."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'cd37a9a6-4a18-433e-9683-741fe0ed624e',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '2dd46a1d-0b7a-46c5-99f8-d96f31c6b738',
    'Desenvolvimento Inclinado na Polia',
    'strength',
    NULL,
    '["Adjust the weight to an appropriate amount and be seated, grasping the handles. Your upper arms should be about 45 degrees to the body, with your head and chest up. The elbows should be bent to about 90 degrees. This will be your starting position.", "Begin by extending through the elbow, pressing the handles together straight in front of you. Keep your shoulder blades retracted as you execute the movement.", "After pausing at full extension, return to the starting position, keeping tension on the cables."]'::jsonb,
    '["cable"]'::jsonb,
    FALSE,
    'CHEST',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '6d47f883-28cc-4a3b-8804-8808a55e53bf',
    'Inclinado com Halteres Bench With Palms Facing In',
    'strength',
    NULL,
    '["Lie back on an incline bench with a dumbbell on each hand on top of your thighs. The palms of your hand will be facing each other.", "By using your thighs to help you get the dumbbells up, clean the dumbbells one arm at a time so that you can hold them at shoulder width.", "Once at shoulder width, keep the palms of your hands with a neutral grip (palms facing each other). Keep your elbows flared out with the upper arms in line with the shoulders (perpendicular to the torso) and the elbows bent creating a 90-degree angle between the upper arm and the forearm. This will be your starting position.", "Now bring down the weights slowly to your side as you breathe in. Keep full control of the dumbbells at all times.", "As you breathe out, push the dumbbells up using your pectoral muscles. Lock your arms in the contracted position, hold for a second and then start coming down slowly. Tip: It should take at least twice as long to go down than to come up.", "Repeat the movement for the prescribed amount of repetitions.", "When you are done, place the dumbbells back in your thighs and then on the floor. This is the safest manner to dispose of the dumbbells."]'::jsonb,
    '["dumbbell"]'::jsonb,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f0a407ee-076a-414c-976c-88e3ab9bc21c',
    'Rosca Inclinada',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'a0da75fa-2f4c-42cd-b49b-bc5252a5627d',
    'Rotação Inclinado com Halteres',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '8c4f7ba2-c47b-4d13-9e10-5e951e16f907',
    'Rosca Martelo Inclinado',
    'strength',
    'Hammer curl performed with dumbbells and at an incline',
    '["Seat yourself on an incline bench with a dumbbell in each hand. You should pressed firmly against he back with your feet together. Allow the dumbbells to hang straight down at your side, holding them with a neutral grip. This will be your starting position.", "Initiate the movement by flexing at the elbow, attempting to keep the upper arm stationary.", "Continue to the top of the movement and pause, then slowly return to the start position."]'::jsonb,
    '["dumbbell", "bench"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'cea5298b-812f-43e3-be33-139b2c0125a9',
    'Rosca Inclinado',
    'strength',
    NULL,
    '["Hold a dumbbell in each hand and lie back on an incline bench.", "The dumbbells should be at arm's length hanging at your sides and your palms should be facing out. This will be your starting position.", "Now as you exhale curl the weight outward and up while keeping your forearms in line with your side deltoids. Continue the curl until the dumbbells are at shoulder height and to the sides of your deltoids. Tip: The end of the movement should look similar to a double biceps pose.", "After a second contraction at the top of the movement, start to inhale and slowly lower the weights back to the starting position using the same path used to bring them up.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '27ce6ad2-1982-4d7b-9e9c-bc744e339849',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '736df8f5-3fc9-4688-b9ce-101b366bf331',
    'Flexão de Braço Inclinado',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'aeffcf91-477a-4ed0-a5c0-8d8a321adbe8',
    'Flexão de Braço Inclinado Inverso',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '832582f6-1e4c-48ea-b9e5-ec91b14ceb2a',
    'Flexão de Braço Inclinado',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '08d1984c-881a-49e3-b2dc-95e1afec5277',
    'Alongamento',
    'stretching',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '35b6c5a4-945f-4e05-b6af-68b5107f4036',
    'Internal Rotation with com Elástico',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '6f42db98-a2de-426e-9c49-e7e8e8eae81c',
    'Remada',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '13023fb3-d182-4a3b-bdbb-d98356203fdf',
    'Iron Cross',
    'strength',
    NULL,
    '[]'::jsonb,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '81fe038e-a8ba-4502-a404-b2e405e45f9f',
    'Isometric Peito Squeezes',
    'plyometrics',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '03d1c23c-417e-400f-a643-4941e12f7ae0',
    'Abdominal',
    'strength',
    NULL,
    '["Lie flat on the floor (or exercise mat) on your back with your arms extended straight back behind your head and your legs extended also. This will be your starting position.", "As you exhale, bend at the waist while simultaneously raising your legs and arms to meet in a jackknife position. Tip: The legs should be extended and lifted at approximately a 35-45 degree angle from the floor and the arms should be extended and parallel to your legs. The upper torso should be off the floor.", "While inhaling, lower your arms and legs back to the starting position.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '94d1749a-5ba0-471a-89d3-831892a50def',
    'com Kettlebell Figure 8',
    'strength',
    NULL,
    '["Place one kettlebell between your legs and take a wider than shoulder width stance. Bend over by pushing your butt out and keeping your back flat.", "Pick up a kettlebell and pass it to your other hand between your legs. The receiving hand should reach from behind the legs. Go back and forth for several repetitions."]'::jsonb,
    '["kettlebell"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '085c98ef-ca9a-4fd0-9f04-793bfcce5d14',
    'Clean com Kettlebell',
    'strength',
    NULL,
    '["Place kettlebell between your feet. To get in the starting position, push your butt back and look straight ahead.", "Clean kettlebell to your shoulder. Clean the kettlebell to your shoulders by extending through the legs and hips as you raise the kettlebell towards your shoulder. The wrist should rotate as you do so.", "Lower kettlebell to a hanging position between your legs while keeping the hamstrings loaded. Keep your head up at all times."]'::jsonb,
    '["kettlebell"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'a432209e-dd7a-41ba-9b9b-36fca03e1052',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'c4e990ce-6e99-4916-b211-efd2c80eb7c2',
    'com Kettlebell Pass Between The Legs',
    'strength',
    NULL,
    '["Place one kettlebell between your legs and take a comfortable stance. Bend over by pushing your butt out and keeping your back flat.", "Pick up a kettlebell and pass it to your other hand between your legs, in the fashion of a W. Go back and forth for several repetitions."]'::jsonb,
    '["kettlebell"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '5d425cd0-0bfd-43de-b601-42689741d069',
    'Desenvolvimento Sentado com Kettlebell',
    'strength',
    NULL,
    '["Sit on the floor and spread your legs out comfortably.", "Clean one kettlebell to your shoulder.", "Press the kettlebell up and out until it is locked out overhead. Return to the starting position."]'::jsonb,
    '["kettlebell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '492891e0-09c9-43e7-8a2f-3dc56d5cfeab',
    'Desenvolvimento com Kettlebell',
    'strength',
    NULL,
    '["Clean two kettlebells two your shoulders.", "Press one kettlebell.", "Lower the kettlebell and immediately press the other kettlebell. Make sure to do the same amount of reps on both sides."]'::jsonb,
    '["kettlebell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '63c39e6c-bba9-46cb-ab1f-ffa7ebc46da6',
    'Agachamento com Kettlebell',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '79985fe8-8872-487c-9302-86c358925e23',
    'Rotação',
    'stretching',
    NULL,
    '["Stand with your legs together and hands by your waist.", "Now move your knees in a circular motion as you breathe normally.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '8e6e6ea1-3dfc-4c50-a563-0dee43c493a3',
    'Elevação',
    'strength',
    NULL,
    '["Position your body on the vertical leg raise bench so that your forearms are resting on the pads next to the torso and holding on to the handles. Your arms will be bent at a 90 degree angle.", "The torso should be straight with the lower back pressed against the pad of the machine and the legs extended pointing towards the floor. This will be your starting position.", "Now as you breathe out, lift your legs up as you keep them extended. Continue this movement until your legs are roughly parallel to the floor and then hold the contraction for a second. Tip: Do not use any momentum or swinging as you perform this exercise.", "Slowly go back to the starting position as you breathe in.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '2b9eef4b-a766-41f7-8cdc-61eb2e41e03f',
    'Abdominal Alternado Ajoelhado na Polia',
    'strength',
    NULL,
    '["Connect a rope attachment to a high pulley cable and position a mat on the floor in front of it.", "Grab the rope with both hands and kneel approximately two feet back from the tower.", "Position the rope behind your head with your hands by your ears.", "Keep your hands in the same place, contract your abs and pull downward on the rope in a crunching movement until your elbows reach your knees.", "Pause briefly at the bottom and rise up in a slow and controlled manner until you reach the starting position.", "Repeat the same downward movement until you halfway down, at which time you begin rotating one of your elbows to the opposite knee.", "Again, pause briefly at the bottom and rise up in a slow and controlled manner until you reach the starting position.", "Repeat the same movement as before, but alternate the other elbow to the opposite knee.", "Continue this series of movements to failure."]'::jsonb,
    '["cable"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '862883ba-637c-4622-a94f-4feda44f5d03',
    'Alongamento Ajoelhado',
    'stretching',
    NULL,
    '["Start by kneeling on a mat with your palms flat and your fingers pointing back toward your knees.", "Slowly lean back keeping your palms flat on the floor until you feel a stretch in your wrists and forearms. Hold for 20-30 seconds."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'deb00137-598e-4377-b87d-bd84e6bd0419',
    'Ajoelhado Hip Flexor',
    'stretching',
    NULL,
    '["Kneel on a mat and bring your right knee up so the bottom of your foot is on the floor and extend your left leg out behind you so the top of your foot is on the floor.", "Shift your weight forward until you feel a stretch in your hip. Hold for 15 seconds, then repeat for your other side."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '4133ff11-2d37-47e7-afae-609607dbe21e',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '86e00286-b205-4cdf-ac36-c8e22b81255b',
    'Agachamento Ajoelhado',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '0ed1fab6-ae46-46e7-ae29-29d2cf92f4ec',
    'Lateral Bound',
    'plyometrics',
    NULL,
    '["Assume a half squat position facing 90 degrees from your direction of travel. This will be your starting position.", "Allow your lead leg to do a countermovement inward as you shift your weight to the outside leg.", "Immediately push off and extend, attempting to bound to the side as far as possible.", "Upon landing, immediately push off in the opposite direction, returning to your original start position.", "Continue back and forth for several repetitions."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'e4bc5a29-5303-47c9-8671-672f344e742d',
    'Elevação Lateral',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ab9fad7b-af9a-4f73-9e34-17df250957f7',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f9422e3b-09a2-4e70-9b2d-18658508a76f',
    'Alongamento',
    'stretching',
    NULL,
    '["Lie flat on your back, bend one knee, and put that foot flat on the floor to stabilize your spine.", "Extend the other leg in the air. If you're tight, you wont be able to straighten it. That's okay. Extend the knee so that the sole of the lifted foot faces the ceiling (or as close as you can get it).", "Slowly straighten the legs as much as possible and then pull the leg toward your nose. Switch sides."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '0bfbe8aa-afae-4d9c-b89f-45d91421607e',
    'Leg Extensions',
    'strength',
    NULL,
    '["For this exercise you will need to use a leg extension machine. First choose your weight and sit on the machine with your legs under the pad (feet pointed forward) and the hands holding the side bars. This will be your starting position. Tip: You will need to adjust the pad so that it falls on top of your lower leg (just above your feet). Also, make sure that your legs form a 90-degree angle between the lower and upper leg. If the angle is less than 90-degrees then that means the knee is over the toes which in turn creates undue stress at the knee joint. If the machine is designed that way, either look for another machine or just make sure that when you start executing the exercise you stop going down once you hit the 90-degree angle.", "Using your quadriceps, extend your legs to the maximum as you exhale. Ensure that the rest of the body remains stationary on the seat. Pause a second on the contracted position.", "Slowly lower the weight back to the original position as you inhale, ensuring that you do not go past the 90-degree angle limit.", "Repeat for the recommended amount of times."]'::jsonb,
    '["machine"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'db78cc6f-25eb-4bc3-9990-a65dcd85adb2',
    'Leg Lift',
    'strength',
    NULL,
    '["While standing up straight with both feet next to each other at around shoulder width, grab a sturdy surface such as the sides of a squat rack or the top of a chair to brace yourself and keep balance.", "With or without an ankle weight, lift one leg behind you as if performing a leg curl but standing up while keeping the other leg straight. Breathe out as you perform this movement.", "Slowly bring the raised leg back to the floor as you breathe in.", "Repeat for the recommended amount of repetitions.", "Repeat the movement with the opposite leg."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '40ab64e0-220a-4f22-ba9b-1e1c9201758d',
    'Leg Pull-In',
    'strength',
    NULL,
    '["Lie on an exercise mat with your legs extended and your hands either palms facing down next to you or under your glutes. Tip: My preference is with the hands next to me. This will be your starting position.", "Bend your knees and pull your upper thighs into your midsection as you breathe out. Continue the motion until your knees are around chest level. Contract your abs as you execute this movement and hold for a second at the top. Tip: As you perform the motion, the lower legs (calves) should always remain parallel to the floor.", "Return to the starting position as you inhale.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'c3770519-1a8a-4a2f-b280-b5f2f009f52b',
    'Levantamento Terra',
    'strength',
    NULL,
    '["Load the pins to an appropriate weight. Position yourself directly between the handles. Grasp the bottom handles with a comfortable grip, and then lower your hips as you take a breath. Look forward with your head and keep your chest up. This will be your starting position.", "Return the weight to the starting position."]'::jsonb,
    '["machine"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'd76df714-6346-47ea-820f-a5b882837a71',
    'Desenvolvimento Declinado',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'feec5395-3351-451a-b0d4-5f012da379df',
    'Remada Alto',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '80dbb620-58bf-4071-92de-098c39f60cc3',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '900ce872-a132-4d24-a638-617a9b53d64c',
    'Remada',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'cb9bce08-1364-4c53-9321-49273cab09f9',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '10257509-eec3-4039-b73c-edf2594017aa',
    'Encolhimento',
    'strength',
    NULL,
    '["Load the pins to an appropriate weight. Position yourself directly between the handles.", "Grasp the top handles with a comfortable grip, and then lower your hips as you take a breath. Look forward with your head and keep your chest up.", "Drive through the floor with your heels, extending your hips and knees as you rise to a standing position. Keep your arms straight throughout the movement, finishing with your shoulders back. This will be your starting position.", "Raise the weight by shrugging the shoulders towards your ears, moving straight up and down.", "Pause at the top of the motion, and then return the weight to the starting position."]'::jsonb,
    '["machine"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'c1b79409-8817-495b-889c-5fdac76f065e',
    'Linear Acceleration Wall Drill',
    'plyometrics',
    NULL,
    '["Lean at around 45 degrees against a wall. Your feet should be together, glutes contracted.", "Begin by lifting your right knee quickly, pausing, and then driving it straight down into the ground.", "Switch legs, raising the opposite knee, and then attacking the ground straight down.", "Repeat once more with your right leg, and as soon as the right foot strikes the ground hammer them out rapidly, alternating left and right as fast as you can."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '6a7d8ae4-2f4d-4900-8cfa-da5d9a079d57',
    'Salto',
    'plyometrics',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '7b316584-19eb-42b2-82db-f88f2169e9d2',
    'Looking At Ceiling',
    'stretching',
    NULL,
    '["Kneel on the floor, holding your heels with both hands.", "Lift your buttocks up and forward while bringing your head back to look up at the ceiling, to give an arch in your back."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '1158085c-ee37-415b-8cb3-4fe452b6edef',
    'Extensão de Tríceps Baixo na Polia',
    'strength',
    NULL,
    '["Select the desired weight and lay down face up on the bench of a seated row machine that has a rope attached to it. Your head should be pointing towards the attachment.", "Grab the outside of the rope ends with your palms facing each other (neutral grip).", "Position your elbows so that they are bent at a 90 degree angle and your upper arms are perpendicular (90 degree angle) to your torso. Tip: Keep the elbows in and make sure that the upper arms point to the ceiling while your forearms point towards the pulley above your head. This will be your starting position.", "As you breathe out, extend your lower arms until they are straight and vertical. The upper arms and elbows remain stationary throughout the movement. Only the forearms should move. Contract the triceps hard for a second.", "As you breathe in slowly return to the starting position.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["cable"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '55e04a31-4896-4670-b6b5-4054447daf6c',
    'Lower Back-SMR',
    'stretching',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '0a5f106c-7fbb-4d98-bd46-1b6519364193',
    'Rosca',
    'stretching',
    NULL,
    '["Lie on your stomach with your arms out to your sides. This will be your starting position.", "Using your lower back muscles, extend your spine lifting your chest off of the ground. Do not use your arms to push yourself up. Keep your head up during the movement. Repeat for 10-20 repetitions."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '5509f3c3-e1af-4d53-9ef5-ea73b3f0857e',
    'Extensão de Tríceps Deitado com Barra',
    'strength',
    NULL,
    '["While holding a barbell or EZ Curl bar with a pronated grip (palms facing forward), lie on your back on a flat bench with your head close to the end of the bench. Tip: If you are holding a barbell grab it using a shoulder-width grip and if you are using an E-Z Bar grab it on the inner handles.", "Extend your arms in front of you and slowly bring the bar back in a semi circular motion (while keeping the arms extended) to a position over your head. At the end of this step your arms should be overhead and parallel to the floor. This will be your starting position. Tip: Keep your elbows in at all times.", "As you inhale, lower the bar by bending at the elbows and while keeping the upper arm stationary. Keep lowering the bar until your forearms are perpendicular to the floor.", "As you exhale bring the bar back up to the starting position by pushing the bar up in a semi-circular motion until the lower arms are also parallel to the floor. Contract the triceps hard at the top of the movement for a second. Tip: Again, only the forearms should move. The upper arms should remain stationary at all times.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f1dacfaf-29bf-4d8d-aad2-bbb8a532a6fd',
    'Extensão de Tríceps Deitado com Halteres',
    'strength',
    NULL,
    '["Lie on a flat bench while holding two dumbbells directly in front of you. Your arms should be fully extended at a 90-degree angle from your torso and the floor. The palms should be facing in and the elbows should be tucked in. This is the starting position.", "As you breathe in and you keep the upper arms stationary with the elbows in, slowly lower the weight until the dumbbells are near your ears.", "At that point, while keeping the elbows in and the upper arms stationary, use the triceps to bring the weight back up to the starting position as you breathe out.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '23d27c91-72df-4ed0-a291-f7b2ec1fba53',
    'Deitado Face Up com Anilha Neck Resistance',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '9334c882-ed57-48ad-839b-39d5c14c4b1e',
    'Deitado Glúteos',
    'stretching',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '2971462f-3734-44ad-984b-f44fb1ad8525',
    'Elevação Deitado Lateral',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '97bfdc61-2578-4f21-b606-824aea4b98bc',
    'Deitado Prone Quadriceps',
    'stretching',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '5a2acb9b-e16a-469d-9a11-ce9919eeebb8',
    'Elevação Deitado Posterior',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '1f8d6953-f37e-44c0-bc53-608c8159c91f',
    'Remada Deitado',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '42d46631-49fa-4b3b-84c8-113d8d9b06e7',
    'Desenvolvimento Deitado',
    'strength',
    NULL,
    '["Lie on a flat bench with either an e-z bar (my preference) or a straight bar placed on the floor behind your head and your feet on the floor.", "Grab the bar behind you, using a medium overhand (pronated) grip, and raise the bar in front of you at arms length. Tip: The arms should be perpendicular to the torso and the floor. The elbows should be tucked in. This is the starting position.", "As you breathe in, slowly lower the weight until the bar lightly touches your forehead while keeping the upper arms and elbows stationary.", "At that point, use the triceps to bring the weight back up to the starting position as you breathe out.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["ez curl bar"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '131dd442-ec4e-4511-8ed6-d65acaae1565',
    'Supino na Máquina',
    'strength',
    NULL,
    '["Sit down on the Chest Press Machine and select the weight.", "Step on the lever provided by the machine since it will help you to bring the handles forward so that you can grab the handles and fully extend the arms.", "Grab the handles with a palms-down grip and lift your elbows so that your upper arms are parallel to the floor to the sides of your torso. Tip: Your forearms will be pointing forward since you are grabbing the handles. Once you bring the handles forward and extend the arms you will be at the starting position.", "Now bring the handles back towards you as you breathe in.", "Push the handles away from you as you flex your pecs and you breathe out. Hold the contraction for a second before going back to the starting position.", "Repeat for the recommended amount of reps.", "When finished step on the lever again and slowly get the handles back to their original place."]'::jsonb,
    '["machine"]'::jsonb,
    FALSE,
    'CHEST',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '3eab5127-8a84-423f-8759-6988b06edf3f',
    'Rosca na Máquina',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '82a4f605-9a30-4ba8-958d-72244702d27d',
    'na Máquina Preacher Curls',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '4ed495e7-8eda-4680-8603-ea21139f9311',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f7fb4af2-a0b6-4dd2-a1aa-657422bbae4b',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f12f15ae-12a9-441c-b5f4-97edb946505d',
    'com Medicine com Bola Peito Pass',
    'plyometrics',
    NULL,
    '["You will need a partner for this exercise. Lacking one, this movement can be performed against a wall.", "Begin facing your partner holding the medicine ball at your torso with both hands.", "Pull the ball to your chest, and reverse the motion by extending through the elbows. For sports applications, you can take a step as you throw.", "Your partner should catch the ball, and throw it back to you.", "Receive the throw with both hands at chest height."]'::jsonb,
    '["medicine ball"]'::jsonb,
    FALSE,
    'CHEST',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'c415ffef-5999-4e6f-a3a5-be6964352544',
    'com Medicine com Bola Scoop Throw',
    'plyometrics',
    NULL,
    '["Assume a semisquat stance with a medicine ball in your hands. Your arms should hang so the ball is near your feet.", "Begin by thrusting the hips forward as you extend through the legs, jumping up.", "As you do, swing your arms up and over your head, keeping them extended, releasing the ball at the peak of your movement. The goal is to throw the ball the greatest distance behind you."]'::jsonb,
    '["medicine ball"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'b5cf756a-ee2d-463f-9f04-8ed2a2f7dc8b',
    'Alongamento',
    'stretching',
    NULL,
    '["Stand so your feet are shoulder width apart and your hands are on your hips.", "Twist at your waist until you feel a stretch. Hold for 10 to 15 seconds, then twist to the other side."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '84a5af7b-761d-4d32-8be8-d4aeb8df3efe',
    'Caminhada',
    'strength',
    NULL,
    '["Place a band around both ankles and another around both knees. There should be enough tension that they are tight when your feet are shoulder width apart.", "To begin, take short steps forward alternating your left and right foot.", "After several steps, do just the opposite and walk backward to where you started."]'::jsonb,
    '["bands"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '85828f02-ee8b-4fbb-aea7-4129fddd4203',
    'Mountain Climbers',
    'plyometrics',
    NULL,
    '["Begin in a pushup position, with your weight supported by your hands and toes. Flexing the knee and hip, bring one leg until the knee is approximately under the hip. This will be your starting position.", "Explosively reverse the positions of your legs, extending the bent leg until the leg is straight and supported by the toe, and bringing the other foot up with the hip and knee flexed. Repeat in an alternating fashion for 20-30 seconds."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '199237cd-ad14-490a-b157-67c8331caae1',
    'Moving Claw Series',
    'plyometrics',
    NULL,
    '["This move helps prepare your running form to help you excel at sprinting. As you run, be sure to flex the knee, aiming to kick your glutes as the hip extends.", "Reload the quad as the leg moves back forward, attacking the ground on the next step.", "Ensure that as you run, you block with the arms, punching through in a rapid 1-2 motion."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '097e0400-d44f-454f-a7a3-424b682a7195',
    'Muscle Up',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '5241fb7b-351c-400f-97eb-783824f68d01',
    'Desenvolvimento',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '82bf2825-87b9-4b9c-a5fb-12147ac721f8',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ed334543-bede-4dff-9a52-297841b47b98',
    'Desenvolvimento',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'da7447ee-433e-4aa9-b13e-7d9ec1a936b1',
    'Oblique Crunches',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '7fe82c12-a2d5-4754-8908-6b13ed59f122',
    'Oblique Crunches - On The no Chão',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'b6f2c026-6957-4b91-b67b-7531eba8490a',
    'Alongamento',
    'stretching',
    NULL,
    '["Lie on a flat bench or step, and hang one leg and arm over the side.", "Bend the knee and hold the top of the foot. As you do this, be careful not to arch your lower back.", "Pull the belly button to the spine to stay in neutral. Press your foot down and into your hand. To add the hip stretch, lift the hip of the leg you're holding up toward the ceiling.", "Switch sides."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'dfafca51-be1b-4dcb-a39a-eeaee98e8617',
    'One-Arm Reto Bench com Halteres Flye',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f9cf2fd4-c32d-423f-87fa-a2377d43d4dc',
    'One-Arm Alto-Pulley na Polia Lateral Bends',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '655fc0e7-d6ed-4224-97e3-b5a735bfba1f',
    'Elevação Inclinado Lateral',
    'strength',
    NULL,
    '["Lie down sideways on an incline bench press with a dumbbell in the hand. Make sure the shoulder is pressing against the incline bench and the arm is lying across your body with the palm around your navel.", "Hold a dumbbell in your uppermost arm while keeping it extended in front of you parallel to the floor. This is your starting position.", "While keeping the dumbbell parallel to the floor at all times, perform a lateral raise. Your arm should travel straight up until it is pointing at the ceiling. Tip: Exhale as you perform this movement. Hold the dumbbell in the position and feel the contraction in the shoulders for a second.", "While inhaling lower the weight across your body back into the starting position.", "Repeat the movement for the prescribed amount of repetitions.", "Switch arms and repeat the movement."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '28d2eabf-32e3-4811-ba5a-c0325384515a',
    'Desenvolvimento no Chão com Kettlebell',
    'strength',
    NULL,
    '["Lie on the floor holding a kettlebell with one hand, with your upper arm supported by the floor. The palm should be facing in.", "Press the kettlebell straight up toward the ceiling, rotating your wrist.", "Lower the kettlebell back to the starting position and repeat."]'::jsonb,
    '["kettlebell"]'::jsonb,
    FALSE,
    'CHEST',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '30672b05-6baf-42e4-aa7d-8d6df366a8d3',
    'Desenvolvimento com Kettlebell',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '9c19255b-cb5c-4562-82af-a73f0fa4514e',
    'Desenvolvimento com Kettlebell',
    'strength',
    NULL,
    '["Hold a kettlebell by the handle. Clean the kettlebell to your shoulder by extending through the legs and hips as you pull the kettlebell towards your shoulder. Rotate your wrist as you do so, so that the palm faces forward. This will be your starting position.", "Dip your body by bending the knees, keeping your torso upright.", "Immediately reverse direction, driving through the heels, in essence jumping to create momentum. As you do so, press the kettlebell overhead to lockout by extending the arms, using your body's momentum to move the weight. Lower the weight to perform the next repetition."]'::jsonb,
    '["kettlebell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'e728a1bf-4cd5-4aef-986c-4858a0041385',
    'One-Arm com Kettlebell Swings',
    'strength',
    NULL,
    '[]'::jsonb,
    '["kettlebell"]'::jsonb,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '625988b3-452a-4eb4-a145-ffece8d69030',
    'One-Arm Lateral Laterals',
    'strength',
    NULL,
    '["Pick a dumbbell and place it in one of your hands. Your non lifting hand should be used to grab something steady such as an incline bench press. Lean towards your lifting arm and away from the hand that is gripping the incline bench as this will allow you to keep your balance.", "Stand with a straight torso and have the dumbbell by your side at arm length with the palm of the hand facing you. This will be your starting position.", "While maintaining the torso stationary (no swinging), lift the dumbbell to your side with a slight bend on the elbow and your hand slightly tilted forward as if pouring water in a glass. Continue to go up until you arm is parallel to the floor. Exhale as you execute this movement and pause for a second at the top.", "Lower the dumbbell back down slowly to the starting position as you inhale.", "Repeat for the recommended amount of repetitions.", "Switch arms and repeat the exercise."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'eb38e9af-a0fd-4b96-9ab3-2908e845d50a',
    'Unilateral Against Wall',
    'stretching',
    NULL,
    '["From a standing position, place a bent arm against a wall or doorway.", "Slowly lean toward your arm until you feel a stretch in your lats."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '4c4e9f41-7a6f-4b49-8f61-99af3318d379',
    'Puxada Unilateral',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'b0f62946-9d90-446c-8802-78d3037beffd',
    'Extensão de Tríceps Unilateral com Halteres',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f5c03a0d-6b99-4dec-b9f4-f3437504de88',
    'One Handed Hang',
    'stretching',
    NULL,
    '["Grab onto a chinup bar with one hand, using a pronated grip. Keep your feet on the floor or a step. Allow the majority of your weight to hang from that hand, while keeping your feet on the ground. Hold for 10-20 seconds and switch sides."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '9cc0e541-9f43-41f2-8b55-7250b02207b5',
    'One Knee To Peito',
    'stretching',
    NULL,
    '["Start off by lying on the floor.", "Extend one leg straight and pull the other knee to your chest. Hold under the knee joint to protect the kneecap.", "Gently tug that knee toward your nose.", "Switch sides. This stretches the buttocks and lower back of the bent leg and the hip flexor of the straight leg."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ef4e20ae-6cc7-449d-adee-3ce4a0c271e4',
    'Agachamento com Barra',
    'strength',
    NULL,
    '["Start by standing about 2 to 3 feet in front of a flat bench with your back facing the bench. Have a barbell in front of you on the floor. Tip: Your feet should be shoulder width apart from each other.", "Bend the knees and use a pronated grip with your hands being wider than shoulder width apart from each other to lift the barbell up until you can rest it on your chest.", "Then lift the barbell over your head and rest it on the base of your neck. Move one foot back so that your toe is resting on the flat bench. Your other foot should be stationary in front of you. Keep your head up at all times as looking down will get you off balance and also maintain a straight back. Tip: Make sure your back is straight and chest is out while performing this exercise.", "As you inhale, slowly lower your leg until your thigh is parallel to the floor. At this point, your knee should be over your toes. Your chest should be directly above the middle of your thigh.", "Leading with the chest and hips and contracting the quadriceps, elevate your leg back to the starting position as you exhale.", "Repeat for the recommended amount of repetitions.", "Switch legs and repeat the movement."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '98ae80fb-50ef-4b74-a818-f8653501c48f',
    'Clean com Kettlebell',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'a60f7f3d-f601-4cb5-a21e-cb65c6b2db5c',
    'Otis-Up',
    'strength',
    NULL,
    '["Secure your feet and lay back on the floor. Your knees should be bent. Hold a weight with both hands to your chest. This will be your starting position.", "Initiate the movement by flexing the hips and spine to raise your torso up from the ground.", "As you move up, press the weight up so that it is above your head at the top of the movement.", "Return the weight to your chest as you reverse the sit-up motion, ensuring not to go all the way down to the floor."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '565c4f4d-56af-4e81-9c2e-6b444cd5c3d7',
    'Acima da Cabeça Lat',
    'stretching',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '68e4dcb5-5992-4c86-9ec4-b369bd7f3798',
    'Acima da Cabeça Slam',
    'plyometrics',
    NULL,
    '["Hold a medine ball with both hands and stand with your feet at shoulder width. This will be your starting position.", "Initiate the countermovement by raising the ball above your head and fully extending your body.", "Reverse the motion, slamming the ball into the ground directly in front of you as hard as you can.", "Receive the ball with both hands on the bounce and repeat the movement."]'::jsonb,
    '["medicine ball"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'e3baf763-977d-4bb7-9d40-c61333aa84dc',
    'Alongamento Acima da Cabeça',
    'stretching',
    NULL,
    '["Standing straight up, lace your fingers together and open your palms to the ceiling. Keep your shoulders down as you extend your arms up.", "To create a full torso stretch, pull your tailbone down and stabilize your torso as you do this. Stretch the muscles on both the front and the back of the torso."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '070320e7-80b1-4277-a598-b8829ce1df04',
    'Acima da Cabeça Tríceps',
    'stretching',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'bf1c9697-d866-4556-8e4c-242754e50687',
    'Desenvolvimento',
    'strength',
    NULL,
    '["Connect a standard handle to a tower, and possibleposition the cable to shoulder height. If not, a low pulley will suffice.", "With your side to the cable, grab the handle with both hands and step away from the tower. You should be approximately arm length away from the pulley, with the tension of the weight on the cable.", "With your feet positioned hip-width apart and knees slightly bent, hold the cable to the middle of your chest. This will be your starting position.", "Press the cable away from your chest, fully extending both arms. You core should be tight and engaged.", "Hold the repetition for several seconds before returning to the starting position.", "At the conclusion of the set, repeat facing the other direction."]'::jsonb,
    '["cable"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'b508692b-43fa-4187-ac37-efbe5e5af99e',
    'Rosca com Halteres',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'bbe41868-ded5-4974-a715-3f675402d0d1',
    'Rosca',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'bb06d83d-5007-425a-b5b0-2c17e0a995e0',
    'Rosca com Barra',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '5a973604-88f3-4ec2-bed3-4ba7e5f2a2fa',
    'Pelvic Tilt Into Bridge',
    'stretching',
    NULL,
    '["Lie down with your feet on the floor, heels directly under your knees.", "Lift only your tailbone to the ceiling to stretch your lower back. (Don't lift the entire spine yet.) Pull in your stomach.", "To go into a bridge, lift the entire spine except the neck."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '62d423dd-7e57-4bd9-9fa0-0e3648bef761',
    'Alongamento',
    'stretching',
    NULL,
    '["In a seated position, loop a belt, rope, or band around one foot. This will be your starting position.", "With the leg extended and the heel off of the ground, pull on the belt so that the foot is inverted, with the inside of the foot being pulled towards you. Hold for 10-20 seconds, and then switch sides."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '0a29ceaa-1f2b-41e9-b32f-9c15a16ab6a1',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'd090a177-c9ff-4a42-925e-225d0763b373',
    'Prancha',
    'strength',
    NULL,
    '["Get into a prone position on the floor, supporting your weight on your toes and your forearms. Your arms are bent and directly below the shoulder.", "Keep your body straight at all times, and hold this position as long as possible. To increase difficulty, an arm or leg can be raised."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '08dff4e4-3ebb-4881-9152-ad3069baf137',
    'com Anilha Pinch',
    'strength',
    NULL,
    '["Grab two wide-rimmed plates and put them together with the smooth sides facing outward", "Use your fingers to grip the outside part of the plate and your thumb for the other side thus holding both plates together. This is the starting position.", "Squeeze the plate with your fingers and thumb. Hold this position for as long as you can.", "Repeat for the recommended amount of sets prescribed in your program.", "Switch arms and repeat the movements."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f92efb10-4347-417e-af41-769a06609b68',
    'Alongamento',
    'stretching',
    NULL,
    '["In a seated position, loop a belt, rope, or band around one foot. This will be your starting position.", "With the leg extended and the heel off of the ground, pull on the belt so that the foot is everted, with the outside of the foot being pulled towards you. Hold for 10-20 seconds, and then switch sides."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '88d25e54-17a7-41bf-8571-c7fc90cfb119',
    'Power Jerk',
    'olympic weightlifting',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '33f8d17b-0cae-4c8e-8502-9965eac4c90a',
    'Prowler Sprint',
    'cardio',
    NULL,
    '["Place your sled on an appropriate surface, loaded to a suitable weight. The sled should provide enough resistance to require effort, but not so heavy that you are significantly slowed down.", "You may use the upright or the low handles for this exercise. Place your hands on the handles with your arms extended, leaning into the implement.", "With good posture, drive through the ground with alternating, short steps. Move as fast as you can for a short distance."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '085a0c62-c67a-40b7-be52-aa826ee43dc9',
    'Pull Through',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '32688f5e-0e53-45f9-be00-22d81f1b2912',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '5ebffb5c-ddad-4bd5-85ca-d5a1aa0535c0',
    'Push-Ups With Feet On An Exercise com Bola',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '56d61459-7e3b-4106-9526-deeae7db9b93',
    'Desenvolvimento',
    'olympic weightlifting',
    NULL,
    '[]'::jsonb,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '63e6d673-c50f-4897-af9b-5e59bc73dcea',
    'Flexão de Braço Lateral',
    'strength',
    NULL,
    '["Get into pushup position on the toes with your hands just outside of shoulder width.", "Perform a pushup by allowing the elbows to flex. As you descend, keep your body straight.", "Do one pushup and as you come up, shift your weight on the left side of the body, twist to the side while bringing the right arm up towards the ceiling in a side plank.", "Lower the arm back to the floor for another pushup and then twist to the other side.", "Repeat the series, alternating each side, for 10 or more reps."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'CHEST',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'b4f96ff4-5443-4002-8fc2-a6e30c82db66',
    'Pushups',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ffc98f1b-3af3-448c-9dca-6256c26dfabc',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '090465ae-751a-43b0-a03a-c4e80467a5ac',
    'Alongamento',
    'stretching',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '4203e35a-64b7-4c45-bc39-af0e6d18d9d3',
    'Quadriceps-SMR',
    'stretching',
    NULL,
    '["Lay facedown on the floor with your weight supported by your hands or forearms. Place a foam roll underneath one leg on the quadriceps, and keep the foot off of the ground. Make sure to relax the leg as much as possible. This will be your starting position.", "Shifting as much weight onto the leg to be stretched as is tolerable, roll over the foam from above the knee to below the hip, holding points of tension for 10-30 seconds. Switch sides."]'::jsonb,
    '["foam roll"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'a2ac99a0-2ebb-44d2-836c-24dc598ec774',
    'Quick Leap',
    'plyometrics',
    NULL,
    '["You will need a box for this exerise.", "Begin facing the box standing 1-2 feet from its edge.", "By utilizing your hips, hop onto the box, landing on both legs. Ensure that you land with your legs bent and your feet flat.", "Immediately upon landing, fully extend through the entire body and swing your arms overhead to explode off of the box. Use your legs to absorb the impact of landing."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'be40854f-3f25-4628-9af9-410203025a0e',
    'Rack Delivery',
    'olympic weightlifting',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'cba118d1-d397-440e-ac54-222feec58e24',
    'Rack Pulls',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'b7c4320b-23e7-40e8-b155-e1389d064fc4',
    'Return Push from Stance',
    'plyometrics',
    NULL,
    '["You will need a partner for this drill.", "Begin in an athletic 2 or 3 point stance.", "At the signal, move into a position to receive the pass from your partner.", "Catch the medicine ball with both hands and immediately throw it back to your partner.", "You can modify this drill by running different routes."]'::jsonb,
    '["medicine ball"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '30b90ed5-7d12-447a-847b-3adc02929366',
    'Supino Inverso com Elástico',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '8329d38d-621f-4e08-adaf-0d9bca3c2271',
    'Agachamento Inverso com Elástico',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '2aeae860-287b-4cef-8f9d-13869fbf4fd7',
    'Levantamento Terra Inverso com Elástico',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f6d31e28-231e-4a49-9c7e-7692bf0d9cdf',
    'Rosca Inverso com Barra',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'd1897ae9-c76c-4b36-bf83-592c220f991c',
    'Rosca Inverso na Polia',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '2bdf11ca-40ef-4ab3-994b-6995917c1343',
    'Inverso Flyes',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'b4e8c504-1ea1-4e8c-8c03-f27ee407d19a',
    'Inverso Flyes With External Rotation',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '4fe6109a-ba22-475e-abe7-d26a1b014af3',
    'Inverso Hyperextension',
    'strength',
    NULL,
    '["Place your feet between the pads after loading an appropriate weight. Lay on the top pad, allowing your hips to hang off the back, while grasping the handles to hold your position.", "To begin the movement, flex the hips, pulling the legs forward.", "Reverse the motion by extending the hips, kicking the leg back. It is very important not to over-extend the hip on this movement, stopping short of your full range of motion.", "Return by again flexing the hip, pulling the carriage forward as far as you can.", "Repeat for the desired number of repetitions."]'::jsonb,
    '["machine"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'c866fb5f-5304-48c2-9218-d527f0c09155',
    'Inverso com Anilha Curls',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '390fa076-8efc-4ca6-a9b3-5f03b02d2b41',
    'Supino Inverso',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'eefbb0c5-aa1e-4bf8-aed0-1665b70ac837',
    'Rhomboids-SMR',
    'stretching',
    NULL,
    '["Lay down with your back on the floor. Place a foam roll underneath your upper back, and cross your arms in front of you, protracting your shoulders. This will be your starting position.", "Raise your hips off of the ground, placing your weight onto the foam roll. Shift your weight to one side at a time, rolling over your middle and upper back. Pause at points of tension for 10-30 seconds."]'::jsonb,
    '["foam roll"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ce05872f-92ca-4cb5-8566-c85cb1a7715f',
    'Salto',
    'plyometrics',
    NULL,
    '["Begin in a relaxed stance with your feet shoulder width apart and hold your arms close to the body.", "To initiate the move, squat down halfway and explode back up as high as possible.", "Fully extend your entire body, reaching overhead as far as possible. As you land, absorb your impact through the legs."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'fb9c0280-ac58-4e4e-922e-c636d4f9a1cf',
    'Rope Climb',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '7308bf3b-ba5f-4179-9275-04a3a0fc938b',
    'Abdominal',
    'strength',
    NULL,
    '["Kneel 1-2 feet in front of a cable system with a rope attached.", "After selecting an appropriate weight, grasp the rope with both hands reaching overhead. Your torso should be upright in the starting position.", "To begin, flex at the spine, attempting to bring your rib cage to your legs as you pull the cable down.", "Pause at the bottom of the motion, and then slowly return to the starting position.", "These can be done with twists or to the side to hit the obliques."]'::jsonb,
    '["cable"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'd1f0c1cc-6fb8-4974-8f31-0287ffed62d7',
    'Alongamento',
    'stretching',
    NULL,
    '["Stand up straight with your legs together, holding a bodybar or broomstick.", "Hold the pole behind your hips with a wider than shoulder width grip. Your palms should be down and your thumbs facing out.", "Slowly lift your arms up behind your head. Don't force it if it gets hard to lift further."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'e983c949-81a6-467a-bbde-279991429bb9',
    'Running, Treadmill',
    'cardio',
    NULL,
    '["To begin, step onto the treadmill and select the desired option from the menu. Most treadmills have a manual setting, or you can select a program to run. Typically, you can enter your age and weight to estimate the amount of calories burned during exercise. Elevation can be adjusted to change the intensity of the workout.", "Treadmills offer convenience, cardiovascular benefits, and usually have less impact than running outside. A 150 lb person will burn over 450 calories running 8 miles per hour for 30 minutes. Maintain proper posture as you run, and only hold onto the handles when necessary, such as when dismounting or checking your heart rate."]'::jsonb,
    '["machine"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '9203e1fc-9c63-42f7-8af0-81dbd72e746b',
    'Barra Fixa',
    'strength',
    NULL,
    '["Take a pronated grip on a pull-up bar.", "From a hanging position, raise yourself a few inches without using your arms. Do this by depressing your shoulder girdle in a reverse shrugging motion.", "Pause at the completion of the movement, and then slowly return to the starting position before performing more repetitions."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'c60282fa-a3a1-4e53-b701-180f7c44082d',
    'Rosca Sentado com Elástico',
    'strength',
    NULL,
    '["Secure a band close to the ground and place a bench a couple feet away from it.", "Seat yourself on the bench and secure the band behind your ankles, beginning with your legs straight. This will be your starting position.", "Flex the knees, bringing your feet towards the bench. You may need to lean back slightly to keep your feet from striking the floor.", "Pause at the completion of the movement, and then slowly return to the starting position."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'fe002bd3-3fd8-481a-ab48-4181a82ab654',
    'Rotação Sentado com Barra',
    'strength',
    NULL,
    '["Start out by sitting at the end of a flat bench with a barbell placed on top of your thighs. Your feet should be shoulder width apart from each other.", "Grip the bar with your palms facing down and make sure your hands are wider than shoulder width apart from each other. Begin to lift the barbell up over your head until your arms are fully extended.", "Now lower the barbell behind your head until it is resting along the base of your neck. This is the starting position.", "While keeping your feet and head stationary, move your waist from side to side so that your oblique muscles feel the contraction. Only move from side to side as far as your waist will allow you to go. Stretching or moving too far can cause an injury to occur. Tip: Use a slow and controlled motion.", "Remember to breathe out while twisting your body to the side and in when moving back to the starting position.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '30c27e88-f337-4afe-b294-4cc5e1ddf380',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'b44f15d5-3fb2-4e08-84da-ca0c1b0932ca',
    'Sentado Bíceps',
    'stretching',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ad446b94-7e6d-4561-9098-f593472b9c40',
    'Sentado na Polia Rows',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f48f8496-5f1d-4c1f-b9fc-e25ff470dccd',
    'Desenvolvimento de Ombros Sentado na Polia',
    'strength',
    NULL,
    '["Adjust the weight to an appropriate amount and be seated, grasping the handles. Your upper arms should be about 90 degrees to the body, with your head and chest up. The elbows should also be bent to about 90 degrees. This will be your starting position.", "Begin by extending through the elbow, pressing the handles together above your head.", "After pausing at the top, return the handles to the starting position. Ensure that you maintain tension on the cables.", "You can also execute this movement with your back off the pad and alternate hands."]'::jsonb,
    '["cable"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'afd7759d-2de2-4c14-8c7a-60b9ca4d4742',
    'Alongamento Sentado',
    'stretching',
    NULL,
    '["Sit up straight on an exercise mat.", "Bend one knee and put that foot on the floor to stabilize the torso.", "Straighten your other leg and flex your ankle.", "Using a band, towel, or your hand if you can reach, pull the toes toward you. Hold for 10 to 20 seconds, then switch sides."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '0a82f1c5-292f-4c24-9ab1-6a67a3d92ad6',
    'Rosca Sentado com Halteres',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '513af414-f227-418d-947b-540b6e6ceeb5',
    'Sentado Reto Bench Leg Pull-In',
    'strength',
    NULL,
    '["Sit on a bench with the legs stretched out in front of you slightly below parallel and your arms holding on to the sides of the bench. Your torso should be leaning backwards around a 45-degree angle from the bench. This will be your starting position.", "Bring the knees in toward you as you move your torso closer to them at the same time. Breathe out as you perform this movement.", "After a second pause, go back to the starting position as you inhale.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'cb6e74fc-e52b-4892-a8f0-29bf27e15d8e',
    'Alongamento Sentado no Chão',
    'stretching',
    NULL,
    '["Sit on a mat with your right leg extended in front of you and your left leg bent with your foot against your right inner thigh.", "Lean forward from your hips and reach for your ankle until you feel a stretch in your hamstring. Hold for 15 seconds, then repeat for your other side."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '1da0bf5f-cf1f-4f96-b3fa-9ad21f994bdd',
    'Sentado Frontal Deltoid',
    'stretching',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '07847b0f-29df-4d08-88af-7e0e81b5d421',
    'Sentado Glúteos',
    'stretching',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '420ac9b9-ab05-42fe-bd3d-8054c88db62e',
    'Sentado Posterior de Coxa',
    'stretching',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '17530660-9904-4c72-add4-45db373e92c1',
    'Alongamento Sentado',
    'stretching',
    NULL,
    '["Loop a belt, rope, or band around one foot. Sit down with both legs extended . This will be your starting position.", "Leaning forward slightly, pull on the belt to draw the toes of your foot back. Hold this position for 10-20 seconds and then repeat with the other leg."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '658f21dd-76a3-4178-a4e3-c5378a984760',
    'Sentado Head Harness Neck Resistance',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '57d53b03-865e-45ce-9788-05f5e3bbe82a',
    'Sentado Leg Tucks',
    'strength',
    NULL,
    '["Sit on a bench with the legs stretched out in front of you slightly below parallel and your arms holding on to the sides of the bench. Your torso should be leaning backwards around a 45-degree angle from the bench. This will be your starting position.", "Bring the knees in toward you as you move your torso closer to them at the same time. Breathe out as you perform this movement.", "After a second pause, go back to the starting position as you inhale.", "Repeat for the recommended amount of repetitions."]'::jsonb,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '9f984618-1fb5-424c-bf46-c50366e45006',
    'Rosca Sentado com Halteres',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '7939c6ee-5443-41d0-9adc-d8c635f5e6f9',
    'Rosca Sentado com Barra',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '9547735c-002d-40c4-a9c9-7644dcfe662a',
    'Elevação Sentado Lateral Lateral',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'd3bce435-6b84-4d31-b15a-4409fa19f565',
    'Desenvolvimento Sentado',
    'strength',
    'Seated triceps press peformed with a bench and an overhead dumbbell',
    '["Sit down on a bench with back support and grasp a dumbbell with both hands and hold it overhead at arm's length. Tip: a better way is to have somebody hand it to you especially if it is very heavy. The resistance should be resting in the palms of your hands with your thumbs around it. The palm of the hand should be facing inward. This will be your starting position.", "Keeping your upper arms close to your head (elbows in) and perpendicular to the floor, lower the resistance in a semi-circular motion behind your head until your forearms touch your biceps. Tip: The upper arms should remain stationary and only the forearms should move. Breathe in as you perform this step.", "Go back to the starting position by using the triceps to raise the dumbbell. Breathe out as you perform this step.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["dumbbell", "bench"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ec61c01e-8995-4824-8499-4fc427a276a6',
    'Rotação',
    'stretching',
    NULL,
    '["With shoulders relaxed and arms resting loosely at your sides (or in your lap if you're seated), gently roll your shoulders forward, up, back, and down.", "Reverse direction. You can do this exercise alternating shoulders or both at the same time."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '3b6e16b0-f194-4523-a53d-76b667df4616',
    'Elevação',
    'stretching',
    NULL,
    '["Relax your arms to your sides and raise your shoulders up toward your ears, then back down."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'cd727c0d-b82b-4c58-b5a1-9d5cc87779a1',
    'Alongamento',
    'stretching',
    NULL,
    '["Reach your left arm across your body and hold it straight."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '85ebb05a-ccb7-496e-8797-d4cbf2e5d443',
    'Alongamento Deitado Lateral no Chão',
    'stretching',
    NULL,
    '["First lie on your left side, bending your left knee in front of you to stabilize your torso (use your abdominal muscles as well to hold you upright).", "Straighten your right leg and rest the right foot on the floor behind your left. Straighten your right arm over your head and gently pull on your right wrist to stretch the entire right side of the body. Switch sides."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '545ea930-8299-44c1-b71d-a4904508c4b7',
    'Lateral Bridge',
    'strength',
    NULL,
    '[]'::jsonb,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '1341fcd9-a457-4844-ad4b-a9e558a4e6f8',
    'Lateral Hop-Sprint',
    'plyometrics',
    NULL,
    '["Stand to the side of a cone or hurdle.", "Begin this drill by hopping sideways over the obstacle, rebounding out of your landing to hop back to where you started.", "Hop for a prescribed number or repetitions as quickly as possible, and finish this drill by sprinting a short distance upon landing the last hop."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ea2a9d3f-b304-4c79-bd73-ee0f28d22300',
    'Lateral Jackknife',
    'strength',
    NULL,
    '[]'::jsonb,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '23690941-e33b-453c-bd73-04558237dc97',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '203e6751-caf0-401a-8bce-19ea8433327a',
    'Elevação Frontal Lateral',
    'strength',
    NULL,
    '["In a standing position, hold a pair of dumbbells at your side. This will be your starting position.", "Keeping your elbows slightly bent, raise the weights directly in front of you to shoulder height, avoiding any swinging or cheating.", "At the top of the exercise move the weights out in front of you, keeping your arms extended.", "Lower the weights with a controlled motion.", "On the next repetition, raise the weights in front of you to shoulder height before moving the weights laterally to your sides.", "Lower the weights to the starting position."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '8d676942-7abc-42da-a527-a2cb33cd7c96',
    'Alongamento Deitado Lateral',
    'stretching',
    NULL,
    '["Start off by lying on your right side and bend your right knee in front of you to stabilize the torso.", "Rest your head on your right hand or shoulder. Lift your left leg upward and hold it by the back of the knee (easier) or the foot (harder).", "Pull your left knee in toward your left shoulder and simultaneously press your foot or knee down to the floor. To intensify this stretch, straighten your left leg. Switch sides."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '04affb54-38fd-4666-b215-1340ad89860d',
    'Alongamento Lateral',
    'stretching',
    NULL,
    '["Start with your shoulders relaxed, gently tilt your head towards your shoulder.", "Assist stretch with a gentle pull on the side of the head."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    NULL,
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'b24cf00b-714b-4f58-81da-867487242110',
    'Lateral To Lateral Chins',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '28ca7766-5297-4749-8cf0-839d20fde6c7',
    'Lateral to Lateral Box Shuffle',
    'plyometrics',
    NULL,
    '["Stand to one side of the box with your left foot resting on the middle of it.", "To begin, jump up and over to the other side of the box, landing with your right foot on top of the box and your left foot on the floor. Swing your arms to aid your movement.", "Continue shuffling back and forth across the box."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'bf78392a-6828-4d4b-b82a-4b838b0078eb',
    'Single-Arm Linear Jammer',
    'strength',
    NULL,
    '["Position a bar into a landmine or securely anchor it in a corner. Load the bar to an appropriate weight.", "Raise the bar from the floor, taking it to your shoulders with one or both hands. Adopt a wide stance. This will be your starting position.", "Perform the movement by extending the elbow, pressing the weight up. Move explosively, extending the hips and knees fully to produce maximal force.", "Return to the starting position."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'cef2c5d6-ec16-40b3-8929-d87d214b1930',
    'Single-Cone Sprint Drill',
    'plyometrics',
    NULL,
    '["This drill teaches quick foot action. You need a single cone. Begin standing next to the cone with one arm back and one arm forward.", "Chop the feet as quickly as possible, blocking with the arms. Circle the cone, keep your knees up, with violent foot action.", "Rest after three trips around the cone."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '4a17477f-4193-49c7-8878-197bfac44eb4',
    'Single-Leg Hop Progression',
    'plyometrics',
    NULL,
    '["Arrange a line of cones in front of you. Assume a relaxed standing position, balanced on one leg. Raise the knee of your opposite leg. This will be your starting position.", "Hop forward, jumping and landing with the same leg over the cone.", "Use a countermovement jump to hop from cone to cone.", "At the end, turn around and go back on the other leg."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '91fd4d1d-827d-4e42-bc47-a7392ab29c9c',
    'Single-Leg Lateral Hop',
    'plyometrics',
    NULL,
    '["Stand to the side of a cone or hurdle. To get into the start position, stand on one leg with your knee slightly bent.", "To begin, execute a counterjump to hop sideways over the cone.", "Land on your jumping leg, and immediately rebound out of it by jumping back to the start position.", "Continue hopping back and forth."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'bc9a881e-ea15-436a-9885-8824986ca1d9',
    'Extensão',
    'strength',
    NULL,
    '["Seat yourself in the machine and adjust it so that you are positioned properly. The pad should be against the lower part of the shin but not in contact with the ankle. Adjust the seat so that the pivot point is in line with your knee. Select a weight appropriate for your abilities.", "Maintaining good posture, fully extend one leg, pausing at the top of the motion.", "Return to the starting position without letting the weight stop, keeping tension on the muscle.", "Repeat for the desired number of repetitions."]'::jsonb,
    '["machine"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'cf53411b-feed-4a46-a793-62b092833479',
    'Unilateral Glúteos Bridge',
    'strength',
    NULL,
    '["Lay on the floor with your feet flat and knees bent.", "Raise one leg off of the ground, pulling the knee to your chest. This will be your starting position.", "Execute the movement by driving through the heel, extending your hip upward and raising your glutes off of the ground.", "Extend as far as possible, pause and then return to the starting position."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f0ce2b4c-947e-47d0-b898-22165fe8b334',
    'Unilateral Push-off',
    'plyometrics',
    NULL,
    '["Stand on the ground with one foot resting on the box, heel close to the edge.", "Push off with your foot on top of the box, trying to gain as much height as possible by extending through the hip and knee.", "Land with the same foot on top of the box, returning your other foot back to the start position."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '8d046864-6f44-40dd-a9fb-5ca0f1b92339',
    'Abdominal',
    'strength',
    'Sit-up performed in the traditional manner',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '9cac79f7-0e6d-446c-a14b-9e439ca19a20',
    'Sled Drag - Harness',
    'strongman',
    NULL,
    '["To begin, load the sled with the desired weight and attach the pulling strap. You can pull with handles, use a harness, or attach the pulling strap to a weight belt.", "Whether pulling forwards or backwards, lean in the direction of travel and progress by extending through the hips and knees."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '007f2da0-4f0a-44e9-ac5b-0246764b9afd',
    'Caminhada Acima da Cabeça',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'a0236442-65ed-481f-be2c-3a0fbd512664',
    'Sled Push',
    'strongman',
    NULL,
    '["Load your pushing sled with the desired weight.", "Take an athletic posture, leaning into the sled with your arms fully extended, grasping the handles. Push the sled as fast as possible, focusing on extending your hips and knees to strengthen your posterior chain."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '745d3b01-1c9b-481a-9f11-ffc85611ec2d',
    'Sled Inverso Flye',
    'strength',
    NULL,
    '["Attach dual handles to a sled connected by a rope or chain. Load the sled to a light weight.", "Face the sled, backing up until there is some tension in the line. Take both handles at arms length at about waist level. Bend the knees slightly and keep your chest and head up. This will be your starting position.", "Without flexing the elbow, pull the handles upward and apart, performing a reverse fly with some external rotation. Your palms should be facing forward as you do this.", "Return to the starting position, taking a couple steps back to take the slack out of the line."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'e71150f5-c909-4aca-843e-0c2afc46d5cc',
    'Sledgehammer Swings',
    'plyometrics',
    NULL,
    '["You will need a tire and a sledgehammer for this exercise. Stand in front of the tire about two feet away from it with a staggered stance. Grip the sledgehammer.", "If you are right handed, your left hand should be at the bottom of the handle, and your right hand should be choking up closer to the head.", "As you bring the sledge up, your right hand slides toward the head; as you swing down, your right hand will slide down to join your left hand. Slam it down as hard as you can against the tire. Control the bounce of the hammer off of the tire.", "Repeat on the other side."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'e9248aa6-be6f-4c0e-b0e5-2d809fb699cb',
    'Remada Curvado na Máquina no Smith',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '0373a429-7e81-469f-b34f-86b2b8d5af06',
    'Supino na Máquina no Smith',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '11b35992-c28e-4b0d-9c99-234d6308adad',
    'Desenvolvimento Declinado na Máquina no Smith',
    'strength',
    NULL,
    '["Position a decline bench in the rack so that the bar will be above your chest. Load an appropriate weight and take your place on the bench.", "Rotate the bar to unhook it from the rack and fully extend your arms. Your back should be slightly arched and your shoulder blades retracted. This will be your starting position.", "Begin the movement by flexing your arms, lowering the bar to your chest.", "Pause briefly, and then extend your arms to push the weight back to the starting position.", "After completing the desired number of repetitions, rotate the bar to rack the weight."]'::jsonb,
    '["machine"]'::jsonb,
    FALSE,
    'CHEST',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f21305fe-2370-47f0-8755-f725e87e206b',
    'Supino Inclinado na Máquina no Smith',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'd6e35414-5e31-48bf-8db5-226e484f269c',
    'Desenvolvimento na Máquina no Smith',
    'strength',
    NULL,
    '["Position a Smith machine bar a couple feet off of the ground. Ensure that it is resting on the safeties. After loading the bar to an appropriate weight, lie underneath the bar. Place the middle of your feet on the bar, tucking your knees to your chest. This will be your starting position.", "Begin the movement by driving through your feet to move the bar upward, extending the hips and knees. Do not lock out your knees.", "At the top of the motion, pause briefly before returning to the starting position."]'::jsonb,
    '["machine"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '99729ef9-41d2-4ccb-b4cb-d29a6e0053e0',
    'Remada na Máquina no Smith',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'fb5226f1-19bd-417e-be29-14a389207419',
    'Agachamento na Máquina no Smith',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '803b4ef9-681c-492d-a597-305e8371706b',
    'Remada na Máquina no Smith',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ab0f507c-3cdb-4dc2-b9f8-38feca34fbd6',
    'Arranco',
    'olympic weightlifting',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'bcfe0e9c-ce17-4e2a-81dd-5015a6ee032f',
    'Snatch',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '0a8bfd42-2a26-4c5d-a420-23a39cd55696',
    'Encolhimento',
    'olympic weightlifting',
    NULL,
    '["Begin with a wide grip, with the bar hanging at the mid thigh position. You can use a hook or overhand grip. Your back should be straight and inclined slightly forward.", "Shrug your shoulders towards your ears. While this exercise can usually by loaded with heavier weight than a snatch, avoid overloading to the point that the execution slows down."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '2e51134f-3505-4db2-9ca0-176586735a15',
    'Snatch',
    'olympic weightlifting',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '462d783d-bf8a-4091-a412-2c01d6734f48',
    'Speed Squats',
    'strength',
    NULL,
    '["This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack that best matches your height. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.", "Hold on to the bar using both arms at each side and lift it off the rack by first pushing with your legs and at the same time straightening your torso.", "Step away from the rack and position your legs using a shoulder width medium stance with the toes slightly pointed out. Keep your head up at all times as looking down will get you off balance and also maintain a straight back. This will be your starting position. (Note: For the purposes of this discussion we will use the medium stance which targets overall development; however you can choose any of the three stances discussed in the foot stances section).", "Begin to lower the bar by bending the knees as you maintain a straight posture with the head up. Continue down until the angle between the upper leg and the calves becomes slightly less than 90-degrees (which is the point in which the upper legs are below parallel to the floor). Inhale as you perform this portion of the movement. Tip: If you performed the exercise correctly, the front of the knees should make an imaginary straight line with the toes that is perpendicular to the front. If your knees are past that imaginary line (if they are past your toes) then you are placing undue stress on the knee and the exercise has been performed incorrectly.", "Begin to raise the bar as fast as possible without involving momentum as you exhale by pushing the floor with the heel of your foot mainly as you straighten the legs again and go back to the starting position. Note: You should perform these exercises as fast as possible but without breaking perfect form and without involving momentum.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '83f44b74-5e9f-4774-9f14-053a693ac973',
    'Salto',
    'plyometrics',
    NULL,
    '["Assume a lunge stance position with one foot forward with the knee bent, and the rear knee nearly touching the ground.", "Ensure that the front knee is over the midline of the foot.", "Extending through both legs, jump as high as possible, swinging your arms to gain lift.", "As you jump, bring your feet together, and move them back to their initial positions as you land.", "Absorb the impact by reverting back to the starting position."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'e42e5dc6-2e57-4d23-b1c4-54e27e77d2e2',
    'Split Squats',
    'stretching',
    NULL,
    '["Being in a standing position. Jump into a split leg position, with one leg forward and one leg back, flexing the knees and lowering your hips slightly as you do so.", "As you descend, immediately reverse direction, standing back up and jumping, reversing the position of your legs. Repeat 5-10 times on each leg."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '56e9a0aa-7054-461e-aa14-f410fdd4c777',
    'Agachamento',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '815c710a-1b8c-4c09-b541-6173612f30b5',
    'Agachamento',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '77d3c37d-8ea3-4aa6-b408-53f144a2e991',
    'Desenvolvimento Em Pé Alternado com Halteres',
    'strength',
    NULL,
    '["Stand with a dumbbell in each hand. Raise the dumbbells to your shoulders with your palms facing forward and your elbows pointed out. This will be your starting position.", "Extend one arm to press the dumbbell straight up, keeping your off hand in place. Do not lean or jerk the weight during the movement.", "After a brief pause, return the weight to the starting position.", "Repeat for the opposite side, continuing to alternate between arms."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '4433d2da-4c8f-462e-b13f-660827a88b95',
    'Elevação Em Pé com Barra',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '0ed04047-6c3d-4e06-a473-993e8f914fbf',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '31e918ca-f6bf-4d50-a1b2-d3a602ffc0ac',
    'Rosca Em Pé na Polia',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '8b9af42d-8e61-4f3b-9670-c87a2130ae8d',
    'Alongamento Em Pé',
    'stretching',
    NULL,
    '["Clasp your hands behind your back with your palms together, straighten arms and then rotate them so your palms face downward.", "Raise your arms up and hold until you feel a stretch in your biceps."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f70ebf9f-7b2a-4c86-8e66-809ddf7e0da7',
    'Desenvolvimento Em Pé',
    'strength',
    NULL,
    '["Place a loaded bar at shoulder level in a rack. With a pronated grip at shoulder width, begin with the bar racked across the front of your shoulders. This is your starting position.", "Initiate the lift by extending the elbows to press the bar overhead. Avoid locking out the elbow as you move the weight behind your head.", "Lower the bar down to the back of the head until your elbow forms a right angle.", "Lift the bar back over your head by extending the elbows", "Lower the bar down to the starting position.", "Alternate in this manner until you complete the recommended amount of repetitions."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '4ca0fa54-398f-49fe-a976-80accef27db0',
    'Desenvolvimento Em Pé na Polia',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'e81f3fce-a71d-40d0-af57-855c2f5155b0',
    'Elevação Em Pé na Máquina',
    'strength',
    'Standing calf raise performed on a machine',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '00bf23d0-b159-41e8-aef2-6904d67ee4b2',
    'Rosca Em Pé Inverso com Halteres',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'a38d7a8e-0c94-4326-9fb3-da21219b7ce9',
    'Elevação Em Pé Frontal com Halteres',
    'strength',
    NULL,
    '["Hold the dumbbells in front of your thighs, palms facing your thighs.", "Keep your arms straight with a slight bend at the elbows but keep them locked. This will be your starting position.", "Raise the dumbbells in a semicircular motion to arm's length overhead as you exhale.", "Slowly return to the starting position using the same path as you inhale.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '84582f99-4686-4e85-a3c4-7d7edd862ef2',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '3bf4f5f7-dc37-46cc-a860-93eeb0e8a989',
    'Alongamento Em Pé',
    'stretching',
    NULL,
    '["Start by standing with your back about two to three feet away from a bench or step.", "Lift one leg behind you and rest your foot on the step,either on your instep or the ball of your foot, whichever you find most comfortable.", "Keep your supporting knee slightly bent and avoid letting that knee extend out beyond your toes. Switch sides."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'c249b93d-1f5e-48a5-b410-5f2f260907a4',
    'Elevação Em Pé Frontal com Barra',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'de9d0e66-df72-40fc-9bf6-14f1fd6f1343',
    'Alongamento Em Pé',
    'stretching',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '7a0c9f91-841f-48db-9fab-2c9255df0acb',
    'Rotação Em Pé',
    'stretching',
    NULL,
    '["Begin standing on one leg, holding to a vertical support.", "Raise the unsupported knee to 90 degrees. This will be your starting position.", "Open the hip as far as possible, attempting to make a big circle with your knee.", "Perform this movement slowly for a number of repetitions, and repeat on the other side."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ec5e047b-533a-497e-8463-962eaef5a29e',
    'Rosca Em Pé',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '74d579ad-763d-4464-9ceb-613fc114d8c8',
    'Salto Em Pé',
    'plyometrics',
    NULL,
    '["This drill is best done in sand or other soft landing surface. Ensure that you are able to measure distance. Stand in a partial squat stance with feet shoulder width apart.", "Utilizing a big arm swing and a countermovement of the legs, jump forward as far as you can.", "Attempt to land with your feet out in front you, reaching as far as possible with your legs.", "Measure the distance from your landing point to the starting point and track results."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'b8d28742-04f1-4f18-bd6d-22edca0539b9',
    'Elevação Em Pé Baixo',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '887d33ab-7343-4311-bd0f-0e0fc51e4c5b',
    'Extensão de Tríceps Em Pé Baixo',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'd08b1d5f-acfe-4a19-a82d-bcd4749124b1',
    'Desenvolvimento Em Pé',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '4d99bf23-cfc7-4c6e-bcfd-ce5792e8ad2e',
    'Em Pé Olympic com Anilha Hand Squeeze',
    'strength',
    NULL,
    '["To begin, stand straight while holding a weight plate by the ridge at arm's length in each hand using a neutral grip (palms facing in). You feet should be shoulder width apart from each other. This will be your starting position.", "Lower the plates until the fingers are nearly extended but can still hold weights. Inhale as you lower the plates.", "Now raise the plates back to the starting position as you exhale by closing your hands.", "Repeat for the recommended amount of repetitions prescribed in your program."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'aa1f23ee-03a6-458c-8b7d-ccd63a0a748d',
    'Rosca Inclinado Em Pé com Halteres',
    'strength',
    NULL,
    '["Stand on the back side of an incline bench as if you were going to be a spotter for someone. Have a dumbbell in one hand and rest it across the incline bench with a supinated (palms up) grip.", "Position your non lifting hand at the corner or side of the incline bench. The chest should be pressed against the top part of the incline and your feet should be pressed against the floor at a wide stance. This is the starting position.", "While holding the upper arm stationary, curl the dumbbell upward while contracting the biceps as you breathe out. Only the forearms should move. Continue the movement until your biceps are fully contracted and the dumbbell is at shoulder level. Hold the contracted position for a second.", "Slowly begin to bring the dumbbells back to starting position as your breathe in.", "Repeat for the recommended amount of repetitions.", "Switch arms while performing this exercise."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'd8b98d31-7640-4fde-b512-425dd8ec3b97',
    'Extensão de Tríceps Em Pé com Halteres',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '21cc3da4-c0d8-479a-98fc-5a74ec54a0d6',
    'Desenvolvimento Em Pé com Halteres',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '24a3729c-863e-4054-b57d-6c8d605be189',
    'Em Pé Pelvic Tilt',
    'stretching',
    NULL,
    '["Start off with your feet hip-distance apart.", "Bend your knees slightly to keep them soft and springy.", "You may want to move your pelvis forward and backward and back few times before holding the tailbone forward in this stretch."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '6588c7ca-2ebe-437f-8862-1c7da6fe2f42',
    'Alongamento Em Pé',
    'stretching',
    NULL,
    '["Stand with your feet hip-distance apart, one foot slightly in front of the other.", "Bend both knees, keeping your back heel on the floor. Switch sides."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '987ff122-93ba-4600-b808-4a06568a17c6',
    'Em Pé Toe Touches',
    'stretching',
    NULL,
    '["Stand with some space in front and behind you.", "Bend at the waist, keeping your legs straight, until you can relax and let your upper body hang down in front of you. Let your arms and hands hang down naturally. Hold for 10 to 20 seconds."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'eef024d4-0610-4b35-885b-7b95d3dcf477',
    'Em Pé Two-Arm Acima da Cabeça Throw',
    'plyometrics',
    NULL,
    '["Stand with your feet shoulder width apart holding a medicine ball in both hands. To begin, reach the medicine ball deep behind your head as you bend the knees slightly and lean back.", "Violently throw the ball forward, flexing at the hip and using your whole body to complete the movement.", "The medicine ball can be thrown to a partner or to a wall, receiving it as it bounces back."]'::jsonb,
    '["medicine ball"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '4a4ec1ba-a1c6-48e5-b8ab-b777bb8d1728',
    'Salto',
    'plyometrics',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'dbe09caf-3e18-4d93-84ee-089423dfe28a',
    'Elevação',
    'strength',
    NULL,
    '["Stand facing a box or bench of an appropriate height with your feet together. This will be your starting position.", "Begin the movement by stepping up, putting your left foot on the top of the bench. Extend through the hip and knee of your front leg to stand up on the box. As you stand on the box with your left leg, flex your right knee and hip, bringing your knee as high as you can.", "Reverse this motion to step down off the box, and then repeat the sequence on the opposite leg."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '8ce16653-4a3b-454f-9ebc-303df1d8e047',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '9d926c8b-41db-41bb-82f4-c6699634290a',
    'Straight-Arm com Halteres Pullover',
    'strength',
    NULL,
    '["Place a dumbbell standing up on a flat bench.", "Ensuring that the dumbbell stays securely placed at the top of the bench, lie perpendicular to the bench (torso across it as in forming a cross) with only your shoulders lying on the surface. Hips should be below the bench and legs bent with feet firmly on the floor. The head will be off the bench as well.", "Grasp the dumbbell with both hands and hold it straight over your chest at arms length. Both palms should be pressing against the underside one of the sides of the dumbbell. This will be your starting position.Caution: Always ensure that the dumbbell used for this exercise is secure. Using a dumbbell with loose plates can result in the dumbbell falling apart and falling on your face.", "While keeping your arms straight, lower the weight slowly in an arc behind your head while breathing in until you feel a stretch on the chest.", "At that point, bring the dumbbell back to the starting position using the arc through which the weight was lowered and exhale as you perform this movement.", "Hold the weight on the initial position for a second and repeat the motion for the prescribed number of repetitions."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'CHEST',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'b14092ff-8f2c-493d-aadb-692ae8aace96',
    'Puxada',
    'strength',
    NULL,
    '["You will start by grabbing the wide bar from the top pulley of a pulldown machine and using a wider than shoulder-width pronated (palms down) grip. Step backwards two feet or so.", "Bend your torso forward at the waist by around 30-degrees with your arms fully extended in front of you and a slight bend at the elbows. If your arms are not fully extended then you need to step a bit more backwards until they are. Once your arms are fully extended and your torso is slightly bent at the waist, tighten the lats and then you are ready to begin.", "While keeping the arms straight, pull the bar down by contracting the lats until your hands are next to the side of the thighs. Breathe out as you perform this step.", "While keeping the arms straight, go back to the starting position while breathing in.", "Repeat for the recommended amount of repetitions."]'::jsonb,
    '["cable"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '9686ce10-fa8e-4350-b0f6-88ce3d4994fe',
    'Salto',
    'plyometrics',
    NULL,
    '["Stand to the side of a box with your inside foot on top of it, close to the edge.", "Begin by swinging the arms upward as you push through the top leg, jumping upward as high as possible. Attempt to drive the opposite knee upward.", "Land in the opposite position that you started, on the opposite side of the box. The foot that was initially on the box will now be on the ground, with the opposite foot now on the box.", "Repeat the movement, crossing back over to the other side."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'a5b25c63-0db5-4e06-bd43-47c72430159c',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'aafa759c-85d9-4668-b67d-68db612f83dc',
    'Levantamento Terra',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ee0b4461-f514-4b5a-9971-44186caccd61',
    'Levantamento Terra',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '5359af8d-c966-4558-b968-4c07d266bf4b',
    'Supine Peito Throw',
    'plyometrics',
    NULL,
    '["This drill is great for chest passes when you lack a partner or a wall of sufficient strength. Lay on the ground on your back with your knees bent.", "Begin with the ball on your chest, held with both hands on the bottom.", "Explode up, extending through the elbow to throw the ball directly above you as high as possible.", "Catch the ball with both hands as it comes down."]'::jsonb,
    '["medicine ball"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '6ccfca53-e054-4193-a9ae-fa65a9971f52',
    'Supine One-Arm Acima da Cabeça Throw',
    'plyometrics',
    NULL,
    '["Lay on the ground on your back with your knees bent. Hold the ball with one hand, extending the arm fully behind your head. This will be your starting position.", "Initiate the movement at the shoulder, throwing the ball directly forward of you as you sit up, attempting to go for maximum distance.", "The ball can be thrown to a partner or bounced off of a wall."]'::jsonb,
    '["medicine ball"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '5c7c274f-9b3b-41be-8cd2-c2ecca089e0b',
    'Supine Two-Arm Acima da Cabeça Throw',
    'plyometrics',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'e82f1304-32fa-4c6d-83d4-7a6b9be4aced',
    'Abdominal Inverso',
    'strength',
    NULL,
    '["Secure a set of suspension straps with the handles hanging about a foot off of the ground. Move yourself into a pushup plank position facing away from the rack.", "Place your feet into the handles. You should maintain a straight posture, not allowing the hips to sag. This will be your starting position.", "Begin the movement by flexing the knees and hips, drawing the knees to your torso. As you do so, anteriorly tilt your pelvis, allowing your spine to flex.", "At the top of the controlled motion, return to the starting position."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '8b6b734a-0351-4d41-979e-086c56726c4c',
    'Desenvolvimento',
    'strength',
    NULL,
    '["Lie down on a flat bench with a dumbbell in each hand on top of your thighs. The palms of your hand will be facing each other.", "By using your thighs to help you get the dumbbells up, clean the dumbbells one arm at a time so that you can hold them in front of you at shoulder width. Note: when holding the dumbbells in front of you, make sure your arms are wider than shoulder width apart from each other using a pronated (palms forward) grip. Allow your elbows to point out. This is your starting position.", "Keeping the upper arms stationary, slowly move the dumbbells in and down in a semi circular motion until they touch the upper chest while inhaling. Keep full control of the dumbbells at all times and do not move the upper arms nor rest the dumbbells on the chest.", "As you breathe out, move the dumbbells up using your triceps and the same semi-circular motion but in reverse. Attempt to keep the dumbbells together as they move up. Lock your arms in the contracted position, hold for a second and then start coming down again slowly again. Tip: It should take at least twice as long to go down than to come up.", "Repeat the movement for the prescribed amount of repetitions of your training program."]'::jsonb,
    '["dumbbell"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '8df20a53-a938-447a-880c-14158ab46057',
    'The Straddle',
    'stretching',
    NULL,
    '["Begin in a seated, upright position. Start by extending your legs in front of you in a V.", "With your hands on the floor, lean forward as far as possible. Hold for 10 to 20 seconds."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f23012c6-82ab-4120-8105-b7affbd7a25b',
    'Thigh Adutor',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '7302165b-b7d4-4512-8943-2fb56a2002a1',
    'Torso Rotation',
    'stretching',
    NULL,
    '["Stand upright holding an exercise ball with both hands. Extend your arms so the ball is straight out in front of you. This will be your starting position.", "Rotate your torso to one side, keeping your eyes on the ball as you move. Now, rotate back to the opposite direction. Repeat for 10-20 repetitions."]'::jsonb,
    '["exercise ball"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'bb2a0ffa-9aff-4233-a3d8-efe6b5520208',
    'Alongamento Lateral',
    'stretching',
    NULL,
    '["Bring right arm across your body and over your left shoulder, holding your elbow with your left hand, until you feel a stretch in your tricep. Then repeat for your other arm."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '2108c51c-060f-4f7e-b0ae-d15536deffbd',
    'Alongamento',
    'stretching',
    NULL,
    '["Reach your hand behind your head, grasp your elbow and gently pull. Hold for 10 to 20 seconds, then switch sides."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '5c6ce9c5-3ba6-4428-a489-574aa0bb810f',
    'Abdominal',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'a02cc8ed-95ed-453b-a4fa-d2e432852da2',
    'Rosca com Halteres',
    'strength',
    'Preacher curl performed with dumbbells',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '62393471-9422-4bb6-8713-f2a630bca2d7',
    'Clean com Kettlebell',
    'strength',
    NULL,
    '["Place two kettlebells between your feet. To get in the starting position, push your butt back and look straight ahead.", "Clean the kettlebells to your shoulders by extending through the legs and hips as you raise the kettlebells towards your shoulders. Rotate your wrists as you do so.", "Lower the kettlebells back to the starting position and repeat."]'::jsonb,
    '["kettlebell"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '317ead2e-d941-4264-968e-bf913b73dcc7',
    'Two-Arm com Kettlebell Jerk',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ab9f7413-9595-4879-8b8f-20d8ad03580f',
    'Remada com Kettlebell',
    'strength',
    NULL,
    '["Place two kettlebells in front of your feet. Bend your knees slightly and then push your butt out as much as possible as you bend over to get in the starting position.", "Grab both kettlebells and pull them to your stomach, retracting your shoulder blades and flexing the elbows. Keep your back straight. Lower and repeat."]'::jsonb,
    '["kettlebell"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '6bed505e-ea7f-4400-b3dc-076f3ccc0676',
    'Underhand na Polia Pulldowns',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'd738c3cd-6833-4232-931f-5b227177ab36',
    'Upper Back-Leg Grab',
    'stretching',
    NULL,
    '["While seated, bend forward to hug your thighs from underneath with both arms.", "Keep your knees together and your legs extended out as you bring your chest down to your knees. You can also stretch your middle back by pulling your back away from your knees as your hugging them."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ce0284ed-fe49-438c-9533-e8b201d59372',
    'Alongamento',
    'stretching',
    NULL,
    '["Clasp fingers together with your thumbs pointing down, round your shoulders as you reach your hands forward."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '45f9a836-3723-4015-9c4b-8ff5b56223f3',
    'Remada com Barra',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'd551fe37-9b7c-432e-925f-7badb326827c',
    'Remada na Polia',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '52840efe-ba73-41b6-ac48-7cd3ab8e13b0',
    'Remada',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '5f0d14d7-1c91-476c-9a5f-25d9723fda45',
    'Alongamento',
    'stretching',
    NULL,
    '["Extend both hands straight above your head, palms touching.", "Slowly push your hands up and back, keeping your back straight."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'SHOULDERS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '9167deb4-d6dd-4e1c-885d-921a3e2a90d8',
    'Walking, Treadmill',
    'cardio',
    NULL,
    '["To begin, step onto the treadmill and select the desired option from the menu. Most treadmills have a manual setting, or you can select a program to run. Typically, you can enter your age and weight to estimate the amount of calories burned during exercise. Elevation can be adjusted to change the intensity of the workout.", "Treadmills offer convenience, cardiovascular benefits, and usually have less impact than walking outside. When walking, you should move at a moderate to fast pace, not a leisurely one. Being an activity of lower intensity, walking doesn burn as many calories as some other activities, but still provides great benefit. A 150 lb person will burn about 175 calories walking 4 miles per hour for 30 minutes, compared to 450 calories running twice as fast. Maintain proper posture as you walk, and only hold onto the handles when necessary, such as when dismounting or checking your heart rate."]'::jsonb,
    '["machine"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'ef867af3-7655-44a1-ba00-33627aa43560',
    'Weighted com Bola Hyperextension',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'eb6fa9d0-7a8c-408e-a274-27d7183d88c0',
    'Weighted com Bola Lateral Bend',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'd1d368b7-8616-4b61-9dd1-961c786ef468',
    'Weighted Crunches',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '8ea98b98-5bcb-4b73-b834-6009636fd09d',
    'Agachamento',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'dc06fa73-dab4-47b6-837e-70cc4e08a9ea',
    'Weighted Pull Ups',
    'strength',
    NULL,
    '["Attach a weight to a dip belt and secure it around your waist. Grab the pull-up bar with the palms of your hands facing forward. For a medium grip, your hands should be spaced at shoulder width. Both arms should be extended in front of you holding the bar at the chosen grip.", "You want to bring your torso back about 30 degrees while creating a curvature in your lower back and sticking your chest out. This will be your starting position.", "Now, exhale and pull your torso up until your head is above your hands. Concentrate on squeezing yourshoulder blades back and down as you reach the top contracted position.", "After a brief moment at the top contracted position, inhale and slowly lower your torso back to the starting position with your arms extended and your lats fully stretched."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'BACK',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'a3933350-0929-43bc-8a73-4806b94aa119',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '48bd8274-6fea-47cb-afe4-94650ebcd943',
    'Agachamento',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '9d856703-6c15-4f3b-aed8-5425ddb42f51',
    'Supino Declinado com Barra',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '130b8199-945e-4dc6-bf95-076996a73df1',
    'Wide-Grip Declinado com Barra Pullover',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '0cefb199-c93f-4053-87c4-9fb2ddbea95b',
    'Puxada',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '79dd0918-f0d7-4acc-b47d-7d0132667033',
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '649d8449-96bb-43af-94c8-e44adee8a2ab',
    'Rosca Em Pé com Barra',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '2a6c9bee-0ba5-4864-83df-4e21ad887a3e',
    'Agachamento com Barra',
    'strength',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'a195ef15-f013-42d2-9c26-97c9b92eb494',
    'Wide Stance Stiff Legs',
    'olympic weightlifting',
    NULL,
    '["Begin with a barbell loaded on the floor. Adopt a wide stance, and then bend at the hips to grab the bar. Your hips should be as far back as possible, and your legs nearly straight. Keep your back straight, and your head and chest up. This will be your starting position.", "Begin the movement be engaging the hips, driving them forward as you allow the arms to hang straight. Continue until you are standing straight up, and then slowly return the weight to the starting position. For successive reps, the weight need not touch the floor."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f5b6a537-bbe1-46ff-ac98-e4151a11e79a',
    'Wind Sprints',
    'strength',
    NULL,
    '["Hang from a pull-up bar using a pronated grip. Your arms and legs should be extended. This will be your starting position.", "Begin by quickly raising one knee as high as you can. Do not swing your body or your legs. 3", "Immediately reverse the motion, returning that leg to the starting position. Simultaneously raise the opposite knee as high as possible.", "Continue alternating between legs until the set is complete."]'::jsonb,
    '["none"]'::jsonb,
    FALSE,
    'CORE',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    '53cd0617-c456-4683-b020-89f967305f8b',
    'Punho Rotations with Straight Bar',
    'strength',
    NULL,
    '["Hold a barbell with both hands and your palms facing down; hands spaced about shoulder width. This will be your starting position.", "Alternating between each of your hands, perform the movement by extending the wrist as though you were rolling up a newspaper. Continue alternating back and forth until failure.", "Reverse the motion by flexing the wrist, rolling the opposite direction. Continue the alternating motion until failure."]'::jsonb,
    '["barbell"]'::jsonb,
    FALSE,
    'ARMS',
    NULL,
...
INSERT INTO exercise_library (id, name, category, description, instructions, equipment, is_iot_compatible, muscle_group, met_value, video_url)
VALUES (
    'f99c9483-85f6-4823-994e-2bfb01441e17',
    'Caminhada',
    'strongman',
    NULL,
    '["The yoke is usually done with a yoke apparatus, but is sometimes seen with refrigerators or other heavy objects.", "Begin by racking the apparatus across the back of the shoulders. With your head looking forward and back arched, lift the yoke by driving through the heels.", "Begin walking as quickly as possible using short, quick steps. You may hold the side posts of the yoke to help steady it and hold it in position. Continue for the given distance as fast as possible, usually 75-100 feet."]'::jsonb,
    '["other"]'::jsonb,
    FALSE,
    'LEGS',
    NULL,
